/**
 * What the shell is told on a local instance.
 *
...
export async function load(event: LocalRouteEvent): Promise<LayoutServerData> {
	...
	return {
		...
		// A local instance has nowhere to send an error report.
