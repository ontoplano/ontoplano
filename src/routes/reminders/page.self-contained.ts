...
export const actions = {
	...
	dismiss: async ({ request, locals }: SelfContainedEvent) => {
		const form = await request.formData();
	...
	addSound: async ({ request, locals }: SelfContainedEvent) => {
		const form = await request.formData();
		try {
	...
	removeSound: async ({ request, locals }: SelfContainedEvent) => {
		const form = await request.formData();
		try {
	...
	setSound: async ({ request, locals }: SelfContainedEvent) => {
		const form = await request.formData();
		try {
