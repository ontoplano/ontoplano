...
export const actions = {
	...
	dismiss: async ({ request, locals }: LocalRouteEvent) => {
		const form = await request.formData();
	...
	addSound: async ({ request, locals }: LocalRouteEvent) => {
		const form = await request.formData();
		try {
	...
	removeSound: async ({ request, locals }: LocalRouteEvent) => {
		const form = await request.formData();
		try {
	...
	setSound: async ({ request, locals }: LocalRouteEvent) => {
		const form = await request.formData();
		try {
