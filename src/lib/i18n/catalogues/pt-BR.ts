...
export const messages: Catalogue = {
	...
	'settings.account.everythingThisAccountOwnsAs':
		'Tudo o que esta conta tem, em JSON: planos, tarefas, diário, hábitos, metas, compras, ideias e configurações.',
	...
	'settings.account.thisAppCanOpenThe':
		'Este app pode abrir a instância oficial, uma que você mesmo executa, ou nenhuma — tudo no telefone.',
	...
	'start.theFirstChargeIsOn':
		'A primeira cobrança é em {firstChargeOn}, e um e-mail avisa dois dias antes.',
	'start.yearly': 'Anual — {yearlyLine}',
	'start.yourFreeDaysAreYours':
		'Seus {trialDaysAhead} dias grátis são seus mesmo se você cancelar na hora.',
