...
export const messages: Catalogue = {
	...
	'accountImport.aDayAlreadyLogged': 'um dia que já estava registrado para esse hábito',
	...
	'accountImport.aManifestBelongsToThe': 'um manifesto pertence ao token que o declarou',
	'accountImport.aSubscriptionWouldStartPosting':
		'uma assinatura passaria a publicar a partir daqui sem que fosse pedido',
	'accountImport.aTokenIsASecret': 'um token é um segredo que esta instância nunca emitiu',
	'accountImport.billingBelongsToTheInstance':
		'o pagamento pertence à instância que recebeu o dinheiro',
	...
	'admin.alwaysAnAdmin': 'sempre admin',
	'admin.billingSandboxWarning':
		'A cobrança está configurada com uma chave SANDBOX — toda cobrança aqui é dinheiro de mentira. A chave real vai em PADDLE_API_KEY antes desta instância vender de verdade.',
	'admin.confirm': 'Confirmar?',
	'admin.dropItWithoutSending': 'Descartar sem enviar',
	'admin.everyAccountSHistoryInOne':
		'O histórico de cada conta em uma coluna, mais recentes primeiro.',
	'admin.hoursAgo': 'há {count}h',
	'admin.id.addressConfirmed': 'Endereço confirmado',
	'admin.id.byAnAdministrator': '· por um administrador',
	...
	'admin.id.history': 'Histórico',
	'admin.id.joined': 'Entrou',
	'admin.id.keepsTheAccountAndLoses': 'mantém a conta e perde todos os poderes de administrador.',
	'admin.id.makeAdmin': 'Tornar admin',
	'admin.id.nothingRecordedYet': 'Nada registrado ainda',
	'admin.id.plan': 'Plano',
	'admin.id.removeAdmin': 'Remover admin',
	'admin.id.resendConfirmation': 'Reenviar confirmação',
	'admin.id.role': 'Função',
	'admin.id.signedInDevices': 'Aparelhos conectados',
	...
	'admin.joined': '· entrou',
	'admin.justNow': 'agora mesmo',
	'admin.last': '{attempts} {attempts2} · última em {lastAttemptAt}',
	...
	'admin.searchByNameOrAddress':
		'Buscar por nome ou endereço. Mais recentes primeiro quando vazio.',
	'admin.sendItAgainAsIt': 'Enviar de novo, como estava',
	...
	'admin.yesMakeAdmin': 'Sim, tornar admin',
	'admin.yesRemoveAdmin': 'Sim, remover admin',
	'admin.you': 'você',
	...
	'app.nextThreeDays': 'Próximos três dias',
	...
	'app.whereTheWeekWent': 'Para onde foi a semana',
	'app.whichRoomsDoYouWant': 'Quais seções você quer?',
	'app.wholeNumbersCountedWith': 'Números inteiros — contados, com + e −',
	'app.wishlist': 'Lista de desejos',
	'app.workouts': 'Treinos',
	'app.yearly': 'Anual',
	'assistant.answeringWith': 'Respondendo com {provider} — {model}.',
	'assistant.askAnything': 'Pergunte sobre o seu plano, ou diga o que mudar.',
	'assistant.didNotGoThrough': 'Não deu certo.',
	'assistant.placeholder': 'Pergunte, ou diga o que fazer',
	'assistant.send': 'Enviar',
	'assistant.stop': 'Parar',
	'assistant.thinking': 'Pensando…',
	'assistant.title': 'Chat',
	'assistant.tryAgain': 'Tentar de novo',
	'assistant.usedTool': 'usou {tool}',
	'attach.attach': 'Anexar',
	'attach.chooseOne': 'Escolher uma que você já tem',
	...
	'audio.noMicrophone': 'Este aparelho não liberou um microfone para o aplicativo.',
	'audio.none': 'Nada gravado ainda.',
	'audio.notSupported': 'Este navegador não consegue gravar.',
	'audio.pause': 'Pausar',
	'audio.pausePlayback': 'Pausar',
	...
	'card.theThingsYouWouldLike':
		'As coisas que você quer um dia, que não são as compras desta semana.',
	'card.theWeekAtAGlance': 'A semana em um relance.',
	'card.thisMonthExpectedPaidAnd':
		'Este mês: esperado, pago, e quais contas ainda estão em aberto.',
	'card.threeThingsThatWentWell': 'Três coisas que foram bem hoje.',
	'card.todayAndTheTwoDays': 'Hoje e os dois dias seguintes, bloco a bloco.',
	'card.whatHasRunLowAnd': 'O que está acabando e quanto comprar.',
	'card.whatIsLeftToBuy': 'O que falta comprar.',
	'card.whatIsStillToDo': 'O que ainda falta fazer hoje.',
	'card.yourMostRecentEntryAnd': 'Sua entrada mais recente, e um campo para escrever uma nova.',
	'card.yourWorkoutsAndHowLong':
		'Seus treinos, e há quanto tempo cada um foi feito pela última vez.',
	...
	'errors.accountImport.thatFileIsTooBig':
		'Esse arquivo é grande demais para restaurar pelo navegador.',
	'errors.accountImport.theFileCarriesAPicture':
		'O arquivo traz uma imagem em um formato que esse app não aceita',
	'errors.accountImport.theFileCarriesASound':
		'O arquivo traz um som em um formato que esse app não aceita',
	'errors.activities.cannotDeleteActivityIsReferenced':
		'Não dá para apagar: a atividade aparece em blocos da agenda ou no histórico de tarefas',
	'errors.activities.cannotDeleteCategoryHasActivities':
		'Não dá para apagar: a categoria tem atividades ou blocos da agenda',
	'errors.activities.categoryAlreadyExists': 'Essa categoria já existe',
	'errors.activities.invalidColorFormat': 'Cor inválida',
	'errors.admin.aSelfHostedInstance': 'Uma instância própria não tem planos',
	'errors.admin.changeSomebodyElseNotYourself': 'Mude outra pessoa, não você',
	'errors.admin.deleteYourOwnAccountFrom': 'Apague a sua própria conta em Configurações, não aqui',
	'errors.admin.thatIsNotADate': 'Isso não é uma data',
	'errors.admin.thatIsNotThisAccounts': 'Esse não é o endereço desta conta — nada foi apagado',
	'errors.admin.thisAccountAlready': 'Essa conta já tem histórico de plano',
	'errors.admin.thisAccountHasNoPlan': 'Essa conta não tem plano para encerrar',
	'errors.admin.thisAccountOwnsTheInstance':
		'Essa conta é dona da instância e é sempre administradora',
	'errors.admin.thisAccountOwnsTheInstanceAndCannot':
		'Essa conta é dona da instância e não pode ser apagada aqui',
	'errors.admin.unknownRole': 'Papel desconhecido',
	'errors.assistantLog.alreadyPutBack': 'Já foi desfeito.',
	'errors.assistantLog.nothingWasRecordedToPut': 'Não há nada registrado para desfazer.',
	'errors.assistantLog.thatCallChangedSomething':
		'Essa chamada mudou alguma coisa; não apagou nada.',
	'errors.assistantLog.thatCallHasNoWay': 'Essa chamada não tem volta a partir daqui.',
	'errors.assistantLog.thatGoalIsGoneSo':
		'Essa meta não existe mais, então a medida não tem para onde voltar.',
	...
	'errors.authenticationRequired': 'Entre na sua conta para fazer isso.',
	'errors.billing.bodyIsNotJson': 'Essa notificação não chegou como JSON.',
	'errors.billing.cycleNotSoldHere': 'Esse não é um ciclo de cobrança que esta instância vende.',
	'errors.billing.noPurchaseToken': 'Essa compra veio sem nada para conferir.',
	'errors.billing.noSubscriptionToChange': 'Não há assinatura para mudar.',
	'errors.billing.notConfiguredHere': 'Esta instância não recebe pagamentos.',
	'errors.billing.planNotSoldHere': 'Esse não é um plano que esta instância vende.',
	'errors.billing.providerAnsweredStrangely':
		'O provedor de pagamento respondeu de um jeito estranho. Tente de novo.',
	'errors.billing.providerDidNotAnswer':
		'O provedor de pagamento não respondeu. Tente de novo em um minuto.',
	'errors.billing.providerRefusedTheChange':
		'O provedor de pagamento não aceitou a mudança. Tente de novo em um minuto.',
	'errors.billing.purchaseBelongsElsewhere': 'Essa compra já pertence a outra conta.',
	'errors.billing.purchaseIsForAnotherPlan': 'Essa compra é de outro plano.',
	...
	'errors.clientErrors.errorReportingIsNotEnabled':
		'O envio de erros não está ligado neste servidor',
	'errors.clientErrors.errorReportingIsNotEnabledForThisAccount':
		'O envio de erros não está ligado nesta conta',
	'errors.diary.atLeastOneWin': 'É preciso pelo menos uma vitória',
	'errors.familyInvite.anEmailAddressIsNeeded': 'É preciso um endereço de e-mail',
	'errors.familyInvite.noAccountHereUses': 'Nenhuma conta aqui usa esse endereço',
	'errors.familyInvite.thisPlanCoversOneAccount': 'Esse plano cobre uma conta',
	'errors.familyInvite.thisPlanIsNotActive': 'Esse plano não está ativo',
	'errors.gallery.anAlbumByThatName': 'Já existe um álbum com esse nome.',
	'errors.goals.invalidColorFormat': 'Cor inválida',
	'errors.goals.invalidDate': 'Data inválida',
	'errors.goals.invalidMeasures': 'Medidas inválidas',
	'errors.goals.invalidStatus': 'Situação inválida',
	'errors.goals.pickAHorizon': 'Escolha um horizonte',
	'errors.goals.thatOneIsCountedFrom': 'Essa é contada a partir dos seus treinos, não digitada',
	'errors.goals.youAlreadyHaveAnArea': 'Você já tem uma área com esse nome',
	'errors.ideas.ideaIsNotMarked': 'Essa ideia não está marcada como aplicada',
	'errors.importVault.everyNoteInThatVault': 'Todas as notas desse cofre estão vazias.',
	'errors.importVault.noMarkdownFiles':
		'Nenhum arquivo markdown aí — escolha os arquivos .md do cofre.',
	'errors.importVault.noneOfThoseAreText':
		'Nenhum desses é arquivo de texto. Um nome terminado em `.md` não faz nada virar markdown.',
	'errors.importVault.thatVaultIsTooBig': 'Esse cofre é grande demais para trazer de uma vez.',
	'errors.imports.noTaskLists':
		'Nenhuma lista de tarefas nesse arquivo — deveria ser o Tasks.json do Takeout',
	'errors.imports.nothingToImportPaste': 'Nada para importar — cole o arquivo ou escolha um',
	'errors.imports.thatDoesNotLookLike':
		'Isso não parece uma exportação do Todoist — sem cabeçalho TYPE/CONTENT',
	'errors.imports.thatFileIsNotJson':
		'Esse arquivo não é JSON — exporte o Tasks pelo Google Takeout',
	'errors.imports.thatFileIsNotJsonExport':
		'Esse arquivo não é JSON — exporte o Keep pelo Google Takeout',
	'errors.imports.thatFileIsTooBig': 'Esse arquivo é grande demais para importar de uma vez',
	...
	'errors.inventory.thatIsMoreOfOne': 'Isso é mais de uma coisa do que cabe em uma casa.',
	'errors.inventory.thatIsNotOne': 'Esse não é um dos seus lugares.',
	'errors.inventory.thereIsAlreadyACategory': 'Já existe uma categoria com esse nome',
	'errors.jsonBody.requestBodyIsTooLarge': 'O corpo da requisição é grande demais',
	'errors.jsonBody.requestBodyMust': 'O corpo da requisição precisa ser um objeto JSON',
	'errors.jsonBody.requestBodyMustBeValid': 'O corpo da requisição precisa ser JSON válido',
	'errors.ledgers.aLedgerByThatName': 'Já existe um livro-caixa com esse nome.',
	'errors.ledgers.noParserKnowsThatExport': 'Nenhum leitor reconhece esse arquivo.',
	'errors.locations.aLocationCannotBeInside': 'Um lugar não pode estar dentro de si mesmo.',
	...
	'errors.newsletter.thatDoesNotLookLike': 'Isso não parece um endereço de e-mail.',
	...
	'errors.oauth.redirectUrisIsRequired': 'redirect_uris é obrigatório',
	'errors.oauth.tooManyRedirectUris': 'redirect_uris demais',
	'errors.onboarding.unknownTemplate': 'Modelo desconhecido',
	'errors.password.theTwoPasswords': 'As duas senhas não são iguais',
	'errors.people.aBirthdayLooksLike1990':
		'Um aniversário se escreve 1990-03-14, ou --03-14 sem o ano',
	...
	'errors.preferences.unknownStyle': 'Estilo desconhecido',
	'errors.preferences.unknownTheme': 'Tema desconhecido',
	'errors.preferences.unknownTimezone': 'Fuso horário desconhecido',
	'errors.push.aPushEndpoint': 'Um endereço de notificação precisa ser https',
	'errors.quotes.nothingToImport': 'Nada para importar',
	'errors.quotes.thatIsMoreThan500': 'Isso é mais de 500 citações',
	'errors.recipes.noShoppingCategoryHoldsFood':
		'Nenhuma categoria de compras guarda comida ainda — marque uma nas configurações',
	'errors.registration.aFreeMonth': 'Um mês grátis que já acabou não dá nada',
	'errors.registration.anInviteLastsBetween1': 'Um convite dura de 1 a 365 dias',
	'errors.registration.invalidDate': 'Data inválida',
	'errors.registration.registeringHereTakesAnInvitation':
		'Criar conta aqui exige um código de convite',
	'errors.registration.thatInvitationCode': 'Esse código de convite não vale, ou já foi usado',
	...
	'errors.ringtones.thatFileIsEmpty': 'Esse arquivo está vazio.',
	'errors.ringtones.thatIsNotAKind': 'Isso não é um tipo de lembrete.',
	'errors.ringtones.thatIsNotASound': 'Esse app não toca esse tipo de som — MP3, OGG ou WAV.',
	'errors.savedFilters.aSavedFilterNeeds': 'Um filtro salvo precisa de um nome',
	'errors.savedFilters.thatIsAsManySaved':
		'Essa é a quantidade máxima de filtros salvos em uma lista',
	'errors.savedFilters.thatIsNotAScreen': 'Isso não é uma tela',
	'errors.savedFilters.thereIsNothingToSave': 'Não há nada para salvar — nada está filtrado',
	'errors.schedule.aDayLooksLike2026': 'Um dia se escreve 2026-09-01',
	'errors.schedule.thatIsMoreThan':
		'Isso é mais de um ano à frente — pergunte por uma semana mais próxima',
	'errors.schemes.aSchemeWithThisName': 'Já existe um esquema com esse nome',
	'errors.sentNotifications.noSuchNotification': 'Essa notificação não existe.',
	'errors.slots.activityRequired': 'Escolha uma atividade',
	'errors.slots.categoryIsRequired': 'A nova atividade precisa de uma categoria',
	'errors.slots.categoryRequired': 'Escolha uma categoria',
	'errors.slots.csvMustHaveAHeader': 'O CSV precisa de um cabeçalho e ao menos uma linha',
	'errors.slots.noSlotsSelected': 'Nenhum bloco escolhido',
	'errors.slots.noTargetDaysSelected': 'Nenhum dia de destino escolhido',
	'errors.slots.noValidSlotsFound': 'Nenhum bloco válido no CSV',
	'errors.slots.thatWorkoutIsNotYours': 'Esse treino não é seu.',
	'errors.slots.workoutRequired': 'Escolha um treino',
	'errors.statements.noParserKnowsThatExport': 'Nenhum leitor reconhece esse arquivo.',
	'errors.streams.pointMustBeAnObject': 'point precisa ser um objeto',
	'errors.streams.pointsMustBeAnArray': 'points precisa ser uma lista',
	'errors.subscriptions.anEmailAddressIsNeeded': 'É preciso um endereço de e-mail',
	'errors.subscriptions.noAccountHereUses': 'Nenhuma conta aqui usa esse endereço',
	'errors.subscriptions.thatAccountAlreadyPays': 'Essa conta já paga por si mesma',
	'errors.subscriptions.thatAccountHasAlreadyBeen': 'Essa conta já foi convidada',
	'errors.subscriptions.thatAccountIsAlready': 'Essa conta já está em um plano',
	'errors.subscriptions.thatPlanIsNoLonger': 'Esse plano não está mais ativo',
	'errors.subscriptions.thereIsNoInvitationWaiting': 'Não há convite esperando',
	'errors.subscriptions.thisPlanCoversOneAccount': 'Esse plano cobre uma conta',
	'errors.subscriptions.thisPlanIsNotActive': 'Esse plano não está ativo',
	'errors.subscriptions.youArePaying':
		'Você mesmo paga por essa conta. Cancele a sua assinatura primeiro e depois aceite.',
	'errors.tags.aTagIsOneWord': 'Uma etiqueta é uma palavra só — sem espaços nem vírgulas',
	'errors.tags.aTagNeedsAName': 'Uma etiqueta precisa de um nome',
	'errors.tags.thatIsMoreTagsThan': 'São mais etiquetas do que uma coisa pode carregar',
	'errors.todos.activityRequired': 'Escolha uma atividade',
	'errors.todos.badOrdering': 'Ordem inválida',
	...
	'errors.tokens.atLeastOneValidScope': 'É preciso pelo menos uma permissão válida',
	'errors.tokens.invalidToken': 'Chave inválida',
	'errors.tokens.thatIsNotSomething': 'Não dá para amarrar uma chave a isso.',
	'errors.tokens.tokenHasBeenRevoked': 'Essa chave foi revogada',
	'errors.tokens.tokenHasExpired': 'Essa chave expirou',
	'errors.tokens.youAlreadyHaveAKey': 'Você já tem uma chave com esse nome.',
	'errors.unexpected': 'Algo deu errado.',
	'errors.webhooks.atLeastOneKnownEvent': 'É preciso pelo menos um evento conhecido',
	...
	'fields.todo.day': 'Dia',
	'fields.todo.leaveItForNoDay': 'Deixe vazio para uma tarefa ainda sem dia.',
	...
	'filters.editFilter': 'Editar este filtro salvo',
	'filters.editingFilter': 'Filtro salvo',
	'filters.filters': 'Filtros',
	'filters.filtersOn': 'Filtros ativos',
	'filters.forgetFilter': 'Forget {name}',
	'filters.forgetForGood': 'Esquecer de vez',
	'filters.forgetIt': 'Esquecer',
	'filters.nameThisFilter': 'What to call it',
	'filters.narrowThisList': 'Filtrar esta lista',
	'filters.noneChosen': 'Nenhum filtro salvo',
	'filters.nothingSavedYet': 'Nada salvo para esta lista ainda.',
	...
	'filters.sureForget': 'Aperte de novo para esquecer {name}.',
	'filters.updateToShowing': 'Apontar para o que está à mostra agora',
	'finance.bills.amountOver': '{amount} a mais',
	'finance.bills.amountUnder': '{amount} a menos',
	'finance.bills.andItsWholePaymentHistory':
		'e todo o seu histórico de pagamentos são apagados para sempre. Para\n\t\t\tmanter o histórico, arquive em vez de apagar.',
	'finance.bills.archive': 'Arquivar {name}',
	'finance.bills.archived': 'Arquivadas ({length})',
	'finance.bills.attachATransactionTo': 'Anexar uma transação a {name}',
	'finance.bills.attachThePayment': 'Anexar o pagamento',
	'finance.bills.delete': 'Apagar {name}',
	'finance.bills.deleteThisBill': 'Apagar esta conta?',
	'finance.bills.difference': 'Diferença',
	'finance.bills.dueDayOfThatMonth': 'Dia de vencimento daquele mês',
	'finance.bills.dueDayOfTheMonth': 'Dia de vencimento do mês',
	...
	'finance.bills.filterByDescription': 'Filtrar por descrição',
	...
	'finance.bills.rent': 'Aluguel',
	'finance.bills.restore': 'Restaurar',
	'finance.bills.rhythm': 'Ritmo',
	'finance.bills.theAmountComesFromThe':
		'O valor vem da linha que você escolher, não do que a conta esperava.',
	'finance.bills.theBillsYouExpectTo':
		'As contas que você espera pagar ficam aqui. Marque uma como paga e o valor que você realmente pagou é registrado.',
	'finance.bills.theLastDayItCan': 'O último dia em que pode ser paga.',
	'finance.bills.undoThePaymentFor': 'Desfazer o pagamento de {name}',
	'finance.bills.undoThisPeriodSPayment': 'Desfazer o pagamento deste período',
	'finance.bills.whatPaidIt': 'O que pagou?',
	'finance.bills.whenItTurnsUpOn':
		'Quando ela aparece na sua semana. 0 é o próprio dia de vencimento.',
	...
	'finance.insights.everyLedger': 'Todos os registros',
	'finance.insights.importAStatementIntoA':
		'Importe um extrato para um registro e isto ganha vida: quanto cada mês custou, para onde foi, e quanto cada etiqueta soma.',
	...
	'finance.insights.lastMonths': 'últimos {w} meses',
	'finance.insights.monthlyCostOf': 'Custo mensal de #{name}',
	'finance.insights.noTagsYet': 'Nenhuma etiqueta ainda.',
	'finance.insights.nothingToReadYet': 'Nada para ler ainda',
	'finance.insights.overMonthWithAny': 'em {monthsWithSpending} mês{s} com algum',
	'finance.insights.spendingStackedByCategory':
		'Gastos empilhados por categoria — toda linha de saída está em exatamente uma faixa.',
	...
	'finance.ledgers.aLedgerIsOnePlace':
		'Um registro é um lugar por onde o dinheiro passa — uma conta corrente, um cartão de crédito. Crie um, depois importe o extrato dele ou escreva uma linha manualmente.',
	...
	'finance.ledgers.andItsLinesGoFor':
		'e suas {count} linhas somem para sempre. Para manter o histórico, arquive em vez de apagar.',
	'finance.ledgers.archive': 'Arquivar {name}',
	'finance.ledgers.archived': '{show} arquivadas ({length})',
	'finance.ledgers.askEveryTime': 'Perguntar sempre',
	'finance.ledgers.bill': 'conta',
	'finance.ledgers.chooseTheFile': 'Escolher o arquivo',
	'finance.ledgers.clear': 'Limpar',
	'finance.ledgers.coffee': 'Café',
	'finance.ledgers.currentAccount': 'Conta corrente',
	...
	'finance.ledgers.deleteThisLedger': 'Apagar este registro?',
	...
	'finance.ledgers.importThisLedgerSExportOr':
		'Importe a exportação deste registro, ou escreva uma linha manualmente. Linhas já importadas nunca são adicionadas duas vezes.',
	...
	'finance.ledgers.ledger': 'Registro',
	'finance.ledgers.line': 'Linha',
	'finance.ledgers.lines': '{count} linhas',
	'finance.ledgers.moneyIn': 'Entradas',
	'finance.ledgers.moneyOut': 'Saídas',
	'finance.ledgers.moneyYouExpectRatherThan':
		'Dinheiro que você espera, não dinheiro que se moveu — aluguel, uma assinatura.',
	...
	'finance.ledgers.newLedger': 'Novo registro',
	...
	'finance.ledgers.noLedgersYet': 'Nenhum registro ainda',
	...
	'finance.ledgers.preselectedWhenImportingIntoThis':
		'Pré-selecionado ao importar para este registro. Pode ser mudado na importação.',
	...
	'finance.ledgers.searchDescriptions': 'Buscar nas descrições',
	'finance.ledgers.shown': '{length} mostradas',
	'finance.ledgers.theBankSOwnId': 'O id próprio do banco',
	'finance.ledgers.theRulesReadThisSo':
		'As regras leem isto, então reescrever reclassifica a linha.',
	'finance.ledgers.twoColumnsInstead': '— duas colunas em vez disso —',
	'finance.ledgers.uncategorized': '{unsorted} sem categoria →',
	...
	'finance.rules.aLineBelongsToThe':
		'Uma linha pertence à primeira categoria que corresponder, então a ordem abaixo decide empates e os totais sempre fecham.',
	'finance.rules.anchor': 'âncora,',
	'finance.rules.and': 'e',
	'finance.rules.categories': 'Categorias',
	'finance.rules.colourFor': 'Cor de {name}',
	'finance.rules.delete': 'Apagar {name}',
	'finance.rules.deleteThisRule': 'Apagar esta regra?',
	...
	'finance.rules.isADigitAndA': 'é um dígito, e\n\t\tum literal',
	'finance.rules.isOr': 'é ou,',
	...
	'finance.rules.needsABackslash': 'precisa de uma barra invertida.',
	'finance.rules.noneYet': 'Nenhuma ainda.',
	'finance.rules.notRunning': 'não está em execução',
	'finance.rules.nothingHere': 'Nada aqui.',
	'finance.rules.or': 'ou',
	...
	'gallery.album': 'álbum',
	'gallery.allAlbums': 'Todos os álbuns',
	'gallery.anAlbumIsWherePictures':
		'Um álbum é onde as fotos ficam. Crie um, e colocar a mesma foto em um segundo álbum nunca a copia — uma foto existe uma única vez, não importa quantos álbuns a contenham.',
	'gallery.delete': 'Apagar {name}',
	'gallery.deleteThisAlbum': 'Apagar este álbum?',
	'gallery.folders': 'Pastas',
	'gallery.gallery': 'Galeria',
	'gallery.id.aPicture': 'Uma foto',
	'gallery.id.addPictures': 'Adicionar fotos',
	'gallery.id.alsoIn': 'Também em: {albums}',
	'gallery.id.alsoPutItIn': 'Também colocar em',
	'gallery.id.dragAPictureOntoAn':
		'Arraste uma foto até um álbum para movê-la — segure Ctrl para colocá-la nos dois.',
	'gallery.id.itStaysIn': 'Ela continua em {albums}.',
	'gallery.id.keepIt': 'Manter',
	'gallery.id.nothingHereYet': 'Nada aqui ainda',
	'gallery.id.removeFromThisAlbum': 'Remover deste álbum',
	'gallery.id.removeThisPicture': 'Remover esta foto?',
	'gallery.id.saveTags': 'Salvar etiquetas',
	'gallery.id.tagsCommasOrSpaces': 'etiquetas, vírgulas ou espaços',
	...
	'gallery.into': 'para',
	'gallery.keepIt': 'Manter',
	'gallery.letsGoOfItsPictures':
		'libera suas {count} fotos. Uma foto que também está em outro álbum continua lá; uma que só existia aqui é apagada junto.',
	'gallery.newAlbum': 'Novo álbum',
	'gallery.noAlbumsInside': 'Nenhum álbum dentro de {name}',
	'gallery.noAlbumsYet': 'Nenhum álbum ainda',
	'gallery.notebooks': 'Cadernos',
	'gallery.notebooks.path.aPicture': 'Uma foto',
	'gallery.notebooks.path.noPicturesInYourNotebooks': 'Nenhuma foto nos seus cadernos',
	'gallery.notebooks.path.pictures': '{title} — fotos',
	...
	'gallery.picture': 'foto',
	'gallery.pictureIntoAlbum': '{willImport} foto{s} em {length} álbum{s2}',
	'gallery.refused': '{willRefuse} recusadas',
	'gallery.rename': 'Renomear {name}',
	...
	'goals.area': 'Área',
	'goals.areas': 'Áreas',
	'goals.booksKmGigs': 'livros, km, shows',
	'goals.chooseTasks': 'Escolher tarefas',
	...
	'goals.countedFromYourWorkouts': 'Contado a partir dos seus treinos',
	'goals.countsFor': 'Conta para {period}',
	'goals.createGoal': 'Criar meta',
	'goals.deleteGoal': 'Apagar meta',
	'goals.deleteGoalBody': 'Apaga “{title}” e as suas medidas. As tarefas ligadas ficam.',
	'goals.doneOfTotal': '{done} de {total} feitas',
	...
	'goals.newArea': 'Nova área',
	'goals.newGoal': 'Nova meta',
	'goals.noActivitiesYet': 'Nenhuma atividade ainda',
	'goals.noArea': 'Nenhuma área',
	'goals.noAreasYet': 'Nenhuma área ainda',
	'goals.noGoalsInThisArea': 'Nenhuma meta nesta área',
	...
	'goals.oneFewerUnit': 'Um {unit} a menos',
	'goals.oneMore': 'Um a mais',
	'goals.oneMoreUnit': 'Mais um {unit}',
	'goals.optionalLeaveItEmptyFor':
		'Opcional. Deixe em branco para uma meta que é simplesmente feita ou não.',
	'goals.partOf': 'Submeta de',
	'goals.partOf2': 'parte de “{title}”',
	'goals.progressTowards': 'Progresso até {value} {unit}',
	...
	'goals.semester': 'Semestre',
	'goals.showClosed': 'Mostrar encerradas',
	'goals.showCompletedToDos': 'Mostrar tarefas concluídas',
	'goals.showEveryArea': 'Mostrar todas as áreas',
	'goals.standalone': '— avulsa —',
	'goals.starts': 'Começa',
	'goals.tasks': 'Tarefas ({length})',
	'goals.toDos': 'A fazer',
	...
	'health.habits.addNote': 'adicionar nota…',
	'health.habits.collapse': 'Recolher',
	'health.habits.confirm': 'Confirmar?',
	'health.habits.createHabit': 'Criar hábito',
	'health.habits.dayStreak': 'sequência de {count} dias',
	'health.habits.daysClean': { one: '{count} dia limpo', other: '{count} dias limpos' },
	'health.habits.doneToday': 'feito hoje',
	'health.habits.eGCoffeeNaps': 'ex.: café, cochilos',
	'health.habits.eGGymReading': 'ex.: academia, leitura',
	'health.habits.eGSmokingBitingNails': 'ex.: fumar, roer unhas',
	'health.habits.editHabit': 'Editar hábito',
	'health.habits.expand': 'Expandir',
	'health.habits.inAllScroll': '{length} ao todo — role a lista.',
	'health.habits.kind': 'Tipo',
	'health.habits.log': 'Registrar',
	'health.habits.logItAgain': 'Registrar de novo',
	'health.habits.logPastEntry': 'Registrar entrada passada:',
	'health.habits.loggedToday': 'registrado hoje',
	'health.habits.loggedTodayTimes': 'Registrado hoje ×{count}',
	'health.habits.newHabit': 'Novo hábito',
	'health.habits.noneSelectedMeansEveryDay': 'Nenhum selecionado significa todo dia.',
	'health.habits.note': 'nota',
	'health.habits.nothingTrackedInThisFilter': 'Nada registrado neste filtro',
	...
	'health.recipes.day': 'Dia',
	'health.recipes.for': 'Para',
	'health.recipes.fromAPage': 'De uma página',
	'health.recipes.id.addAPicture': 'Adicionar uma foto',
	'health.recipes.id.addThem': 'Adicioná-los',
	'health.recipes.id.addedOfThem': 'Adicionados {added} deles.',
	'health.recipes.id.anythingNewGoesOntoThe':
		'Tudo que for novo entra na lista de compras como algo que você não tem.',
	'health.recipes.id.anythingYouFinishedOffGoes':
		'Tudo que você acabou volta para a lista de compras.',
	'health.recipes.id.at': 'Às',
	'health.recipes.id.cook': 'Cozinhar',
	'health.recipes.id.cookItNow': 'Cozinhar agora',
	'health.recipes.id.cookedIt': 'Cozinhou',
	'health.recipes.id.countsAs': 'Conta como',
	'health.recipes.id.day': 'Dia',
	'health.recipes.id.deleteTheRecipe': 'Apagar a receita',
	'health.recipes.id.deleteThisRecipe': 'Apagar esta receita?',
	'health.recipes.id.editRecipe': 'Editar receita',
	'health.recipes.id.findOnTheShoppingList': 'Encontrar {name} na lista de compras',
	'health.recipes.id.for': 'Para',
	'health.recipes.id.from': 'De {source}',
	...
	'health.recipes.id.markdownHeadingsListsNumbers': 'Markdown: títulos, listas, números.',
	'health.recipes.id.method': 'Modo de preparo',
	'health.recipes.id.min': '{minutes} min',
	'health.recipes.id.minutes': 'Minutos',
	'health.recipes.id.noPicturesYetThe':
		'Nenhuma foto ainda — a primeira que você adicionar é a que aparece na lista.',
	'health.recipes.id.notInTheCupboard': '{length} fora do armário',
	'health.recipes.id.nothingInItYet': 'Nada nela ainda.',
	'health.recipes.id.nothingWrittenYet': 'Nada escrito ainda.',
	'health.recipes.id.ofUpTo': '{length} de {most}, até {kilobytes}KB cada',
	'health.recipes.id.oliveOil': 'azeite',
	'health.recipes.id.onePerLineBulletsNumbers':
		'Um por linha. Marcadores, números e títulos são ignorados; o que vier depois de uma vírgula\n\t\t\t\t\t\t\tvira uma nota.',
	'health.recipes.id.pasteAList': 'Colar uma lista',
	'health.recipes.id.pasteTheIngredients': 'Colar os ingredientes',
	...
	'health.recipes.id.serves': 'Serve',
	'health.recipes.id.serves2': 'serve {servings}',
	'health.recipes.id.tbsp': 'colher de sopa',
	...
	'health.recipes.minutes': 'Minutos',
	'health.recipes.missing': 'faltam {missing} {ingredients}',
	'health.recipes.newRecipe': 'Nova receita',
	'health.recipes.noFoodCategoryYet': 'Nenhuma categoria de comida ainda.',
	'health.recipes.noRecipesYet': 'Nenhuma receita ainda',
	'health.recipes.nothingInItYet': 'nada nela ainda',
	...
	'health.recipes.serves': 'Serve',
	'health.recipes.serves2': 'serve {servings}',
	'health.recipes.showAll': 'Mostrar tudo',
	'health.recipes.showAllRecipes': 'Mostrar todas as receitas',
	'health.recipes.tickOneOnTheShopping': 'Marque um na lista de compras.',
	'health.recipes.whatICanMakeNow': 'O que posso fazer agora',
	'health.recipes.whatItIs': 'O que é',
	'health.recipes.whereItCameFrom': 'De onde veio',
	'health.recipes.whereItCameFromOptional': 'De onde veio (opcional)',
	'health.recipes.writeOnePutItOn':
		'Escreva uma, coloque em um dia, e a lista de compras se preenche sozinha com o que falta.',
	'health.recipes.youHaveEverything': 'você tem tudo',
	'health.workouts.aboutHowLongMin': 'Mais ou menos quanto tempo (min)',
	'health.workouts.aboutMinutes': ', ~{minutes} min',
	'health.workouts.addALine': 'Adicionar uma linha',
	'health.workouts.addTheCategory': 'Adicionar a categoria',
	'health.workouts.anythingWorthSaying': 'Algo que valha a pena dizer',
	'health.workouts.archive': 'Arquivar {title}',
	'health.workouts.archived': 'Arquivados ({length})',
	'health.workouts.askForThisOneEarlier': 'Pedir este mais cedo',
	'health.workouts.askForThisOneLater': 'Pedir este mais tarde',
	'health.workouts.benchRowsDips48': 'Supino, remada, mergulho. 4×8.',
	'health.workouts.categories': 'Categorias',
	'health.workouts.categoriesOfWorkout': 'Categorias de treino',
	'health.workouts.correctTheSessionOn': 'Corrigir a sessão de {doneOn}',
	'health.workouts.correctThis': 'Corrigir isto',
	'health.workouts.correctWhatYouDid': 'Corrigir o que você fez',
	'health.workouts.day': 'Dia',
	'health.workouts.delete': 'Apagar {title}',
	'health.workouts.deleteThisWorkout': 'Apagar este treino?',
	'health.workouts.doneJustNow': 'Feito agora há pouco',
	'health.workouts.edit': 'Editar {title}',
	'health.workouts.editWorkout': 'Editar treino',
	'health.workouts.everythingHereIsOptionalA':
		'Tudo aqui é opcional. Uma sessão sem nada medido ainda é uma sessão.',
	'health.workouts.feltHeavyRightKneeComplained':
		'Pesou. O joelho direito reclamou na última série.',
	'health.workouts.howMuch': 'Quanto',
	...
	'health.workouts.markDone': 'Marcar {title} como feito',
	'health.workouts.measureSomethingElse': 'Medir outra coisa',
	'health.workouts.min': 'min',
	'health.workouts.minutes': 'Minutos',
	'health.workouts.moveDown': 'Mover {activity} para baixo',
	'health.workouts.moveUp': 'Mover {activity} para cima',
	'health.workouts.nbspLastDone': ' · feito pela última vez',
	'health.workouts.newCategory': 'Nova categoria',
	'health.workouts.newWorkout': 'Novo treino',
	'health.workouts.noCategory': '— sem categoria —',
	'health.workouts.noCategory2': 'Sem categoria',
	'health.workouts.noPlanWrittenYet': 'Nenhum plano escrito ainda — Editar cria um.',
	'health.workouts.noWorkoutsYet': 'Nenhum treino ainda',
	'health.workouts.nothingWrittenDownYetRecord':
		'Nada anotado ainda. Registre o que você fez e quanto, e isso vira\n\t\t\t\t\t\t\t\t\t\talgo que você pode olhar depois.',
	'health.workouts.plan': 'Plano',
	'health.workouts.planOntoADay': 'Planejar {title} em um dia',
	'health.workouts.pushDay': 'Dia de empurrar',
	'health.workouts.putItOnADay': 'Colocar em um dia',
	'health.workouts.putOnTheDay': 'Colocar no dia',
	'health.workouts.putThisWorkoutAway': 'Guardar este treino — o histórico dele permanece',
	'health.workouts.ran': 'correu',
	'health.workouts.remove': 'Remover {name}',
	'health.workouts.removeTheSessionOn': 'Remover a sessão de {doneOn}',
	'health.workouts.removeThis': 'Remover isto',
	'health.workouts.removeThisSession': 'Remover esta sessão?',
	'health.workouts.rename': 'Renomear {name}',
	'health.workouts.restore': 'Restaurar',
	'health.workouts.saveTheName': 'Salvar o nome',
	'health.workouts.showThePlanFor': 'Mostrar o plano de {title}',
	'health.workouts.stopMeasuring': 'Parar de medir {activity}',
	'health.workouts.suggestedWhenYouWriteA':
		'Sugerido quando você registra uma sessão. Uma corrida mede quilômetros; um dia de empurrar mede\n\t\t\t\t\to que você levantou no supino e quantas repetições.',
	'health.workouts.swimming': 'Natação',
	'health.workouts.takeOutTheLineFor': 'Tirar a linha de {row}',
	'health.workouts.takeThisLineOut': 'Tirar esta linha',
	'health.workouts.takeThisOneOut': 'Tirar este',
	'health.workouts.thisRow': 'esta linha',
	'health.workouts.time': 'Tempo',
	'health.workouts.what': 'O que',
	'health.workouts.whatDidYouDo': 'O que você fez?',
	'health.workouts.whatItMeasures': 'O que ele mede',
	'health.workouts.whatYouDid': 'O que você fez',
	'health.workouts.whatYouRecordedOn': 'O que você registrou em',
	'health.workouts.workoutsYouCanDropOnto':
		'Treinos que você pode soltar na semana como uma refeição.',
	'health.workouts.writeAWorkoutDown':
		'Registre um treino — um plano e quanto tempo leva — e ele fica pronto para colocar em um dia.',
	'health.workouts.writeDownWhatYouDid': 'Registrar o que você fez',
	'health.workouts.writeDownWhatYouDid2': 'Registrar o que você fez em {title}',
	'health.workouts.writeItDown': 'Registrá-lo',
	'health.workouts.writeOneDown': 'Registrar um',
	'health.workouts.yoursToNameAWorkout':
		'Seu para nomear. Um treino continua existindo se você remover a categoria em que estava.',
	...
	'home.3Wins': '3 vitórias',
	'home.aCopyOfOntoplanoFor': 'Uma cópia do Ontoplano para testar as coisas.',
	'home.accept': 'Aceitar',
	'home.account': 'Conta',
	'home.accountAndHelp': 'Conta e ajuda',
	'home.addABill': 'Adicionar uma conta',
	'home.addATodo': 'Adicionar tarefa',
	'home.addAWorkout': 'Adicionar um treino',
	'home.addAnItem': 'Adicionar um item',
	'home.aiAmpIntegrations': 'IA e integrações',
	...
	'home.first': '{oldest} primeiro',
	'home.freshDemoAccountEverything': 'Conta de demonstração nova — tudo voltou como era.',
	'home.goToASection': 'Ir para uma seção',
	'home.goals': 'Metas',
	'home.habits': 'Hábitos',
	'home.hideCard': 'Ocultar {card}',
	'home.hideThisCard': 'Ocultar este cartão',
	'home.home': 'Início',
	'home.hoursAndMinutesShort': '{hours} h {minutes}',
	'home.hoursShort': '{hours} h',
	'home.ideas': 'Ideias',
	'home.in': 'em',
	'home.inHours': { one: 'em {count} hora', other: 'em {count} horas' },
	'home.inMinutes': { one: 'em {count} minuto', other: 'em {count} minutos' },
	'home.inProgress': '{doing} em andamento',
	'home.itIsAndThisInstance':
		'É {app} e esta instância roda {instance} — algumas coisas podem não funcionar até ela se atualizar.',
	'home.jumpToASection': 'Pular para uma seção',
	'home.lastDone': 'última {date}',
	'home.lastWeekIsStillOpen': 'A semana passada ainda está aberta —',
	'home.latestToDos': 'Últimas tarefas',
	'home.ldquoRdquo': '“{text}”',
	'home.leaveTheCardsAsThey': 'Deixar os cartões como estavam',
	'home.left': 'restantes',
	'home.loading': 'Carregando',
	'home.mdash': '— {author}',
	'home.menu': 'Menu',
	'home.minutesLeft': { one: 'falta {count} minuto', other: 'faltam {count} minutos' },
	'home.minutesShort': '{minutes} min',
	'home.more': '+{todoPreview} a mais',
	'home.more2': '+{goalPreview} a mais',
	'home.more3': '+{length} a mais',
	'home.neverYet': 'nunca ainda',
	'home.newCard': 'Novo cartão',
	'home.nextEyebrow': 'A seguir',
	'home.nextThreeDays': 'Próximos três dias',
	'home.noArea': 'Nenhuma área',
	'home.noBillsYetWriteDown':
		'Nenhuma conta ainda. Anote o que você espera pagar e o mês guarda o placar.',
	'home.noGoalsForThisPeriod':
		'Nenhuma meta para este período. Uma meta é um compromisso com uma data.',
	'home.noIdeasYetThisIs': 'Nenhuma ideia ainda. Este é o lugar para as que não têm outro destino.',
	'home.noMeasure': 'sem medida',
	'home.noNotebooksYetOneHolds':
		'No notebooks yet. One holds everything about a subject you keep coming back to.',
	'home.noQuotesYetAddSome': 'Nenhuma citação ainda. Adicione algumas na configuração.',
	'home.noThanks': 'Não, obrigado',
	'home.noWorkoutsYetWriteOne':
		'Nenhum treino ainda. Registre um e solte-o na semana como uma refeição.',
	'home.notNow': 'Agora não',
	...
	'home.nothingOnTheWishlist':
		'Nada na lista de desejos. Ela é para o que vale lembrar e ainda não vale comprar.',
	'home.nothingPlanned': 'Nada planejado.',
	'home.nothingSurvives': 'nada sobrevive',
	'home.nothingTickedOffThisWeek': 'Nada concluído nesta semana ainda.',
	'home.nothingToBuyTheList':
		'Nada para comprar. A lista guarda o que está em falta e o que você pode querer um dia.',
	'home.nothingTrackedYetAHabit':
		'Nada registrado ainda. Um hábito é algo que você quer fazer — ou parar de fazer — na maioria dos dias.',
	'home.nothingWrittenYetWhateverHappened':
		'Nada escrito ainda. O que quer que tenha acontecido hoje, em quantas palavras você quiser.',
	'home.nowEyebrow': 'Agora',
	...
	'home.rearrangeTheCards': 'Reorganizar os cartões',
	'home.reportThisError': 'Reportar este erro',
	'home.resetDemoAccount': 'Reiniciar conta de demonstração',
	'home.reviewIt': 'Revisar',
	'home.saveWins': 'Salvar vitórias',
	'home.selectAll': 'Selecionar todos',
	'home.sentOnlyWhatBrokeWent':
		'Enviado. Só o que quebrou foi enviado — nunca o que você escreveu.',
	'home.shopping': 'Compras',
	'home.showingNewestFirst': 'Mostrando as mais recentes primeiro',
	'home.showingOldestFirst': 'Mostrando as mais antigas primeiro',
	'home.signOut': 'Sair',
	'home.skipped': 'Pulada',
	'home.skipped2': '{skipped} puladas',
	'home.somethingWentWrong': 'Algo deu errado.',
	'home.staging': 'Homologação.',
	'home.staging2': 'Homologação',
	'home.tagsCommaSeparated': 'Tags (separadas por vírgula)',
	'home.thatCouldNotBeSent': 'Isso também não pôde ser enviado.',
	'home.thatDidNotWorkReload': 'Isso não funcionou. Recarregue e tente de novo.',
	...
	'home.todaySTasks': 'Tarefas de hoje',
	'home.tomorrow': 'Amanhã',
	'home.unanswered': 'sem resposta.',
	'home.unselectAll': 'Desmarcar todos',
	'home.updateTheApp': 'Atualize o app.',
	'home.weekPlan': 'Plano da semana',
	'home.weeksAreStillOpen': 'semanas ainda estão abertas — a mais antiga é',
	'home.whatSOnYourMind': 'No que você está pensando?',
	'home.whatWentWellToday': 'O que foi bom hoje',
	'home.whereTheWeekWent': 'Para onde foi a semana',
	'home.whereThisLives': 'Onde isso fica',
	'home.widgets': 'Widgets',
	'home.win1': 'Vitória 1',
	'home.win2': 'Vitória 2',
	'home.win3': 'Vitória 3',
	'home.wishlist': 'Lista de desejos',
	'home.with': ', com',
	'home.withNoAnswer': 'sem resposta.',
	'home.workouts': 'Treinos',
	'home.writeSomethingDown': 'Escreva algo',
	...
	'inventory.addTheCategory': 'Adicionar a categoria',
	'inventory.anItemJoinsThisList':
		'Um item entra nesta lista quando há menos dele do que o que você mantém.',
	'inventory.archive': 'Arquivar',
	'inventory.archived': '{show} arquivados',
	'inventory.atLeast': 'ao menos',
	'inventory.atMost': 'no máximo',
	'inventory.attributes': 'Atributos',
	'inventory.bought': '{show} comprados',
	'inventory.categories': 'Categorias',
	'inventory.changeIs': 'mudança é',
	'inventory.changesAre': 'mudanças são',
	'inventory.clearThem': 'Limpar',
	'inventory.confirm': 'Confirmar?',
	'inventory.delete': 'Excluir {name}',
	'inventory.dragAThingOntoA': 'Arraste algo até um local para dizer onde ele fica.',
	'inventory.edit': 'Editar {name}',
	'inventory.editItem': 'Editar item',
	'inventory.everybodyOnYourFamilyPlan':
		'Todos no seu plano família veem esta seção e podem preenchê-la',
	...
	'inventory.inventoryIsWhatYouKeep':
		'Inventário é o que você mantém estocado; a lista de desejos é o que você talvez compre um dia.',
	'inventory.itHoldsFood': 'Guarda comida',
	'inventory.keep': 'Manter',
	'inventory.keepTheOldName': 'Manter o nome antigo',
	...
	'inventory.narrowTheListToWhat': 'Reduza a lista ao que você procura.',
	...
	'inventory.noItemsMatchTheCurrent': 'Nenhum item corresponde ao filtro atual.',
	'inventory.noPriceYet': 'ainda sem preço',
	'inventory.noPriceYetSo': '{unpriced} {have} ainda sem preço, então o total real é maior.',
	'inventory.noValue': 'sem valor',
	'inventory.notShowing': 'Não mostrando {notShowing} {items}',
	'inventory.nothingHasRunLow': 'Nada está acabando',
	'inventory.nothingHereMatchesTheCurrent': 'Nada aqui corresponde ao filtro atual.',
	'inventory.nothingIsThrownAwayThis': 'Nada é jogado fora. Isso só tira a prateleira da árvore.',
	'inventory.nothingItIsTop': '— nada, é o nível superior —',
	'inventory.nothingSaysAnythingYet': 'Nada diz nada ainda',
	'inventory.ofThemHaveNo': '· {pricedCount} deles ainda não têm preço',
	'inventory.oneFewer': 'Um a menos',
	'inventory.oneFewer2': 'Um {name} a menos',
	...
	'inventory.renameOrMove2': 'Renomear ou mover {name}',
	'inventory.renameThisAttribute': 'Renomear este atributo',
	'inventory.renameThisValue': 'Renomear este valor',
	...
	'inventory.showWhatYouPutAway': 'Mostrar o que você guardou ({snoozed})',
	...
	'inventory.whatYourThingsSayAbout': 'O que suas coisas dizem sobre si mesmas.',
	'inventory.whateverIsInsideItMoves':
		'O que estiver dentro dele sobe um nível, e as coisas guardadas aqui continuam existindo — elas só perdem o endereço.',
	'inventory.whereThingsLive': 'Onde as coisas ficam',
	'inventory.whichList': 'Qual lista',
	'inventory.whiteChest': 'Baú branco',
	...
	'ledgers.card': 'Cartão',
	'ledgers.cash': 'Dinheiro',
	'legal.privacy.aHashOfYourPassword': 'Um hash da sua senha. Não a senha.',
	'legal.privacy.aShortHistoryOfWhat':
		'Um breve histórico do que aconteceu com sua conta — entrar, trocar a senha, exportar, uma\n\t\tmudança de plano. Você vê a mesma lista que um administrador vê.',
	'legal.privacy.anythingYouConnectWithAn':
		'Qualquer coisa que você conectar com um token de API vê exatamente os escopos que você deu\n\t\ta esse token, e nada além disso. Você pode revogar um a qualquer momento em Configurações → Integrações.',
	'legal.privacy.askWhoeverRunsThisInstance': 'Pergunte a quem administra esta instância.',
	'legal.privacy.askingAboutAnyOfThis': 'Perguntando sobre isso',
	'legal.privacy.backupsAreReplicatedToObject':
		'Backups são replicados para armazenamento de objetos.',
	'legal.privacy.backupsAreTheExceptionAnd':
		'Backups são a exceção, e a ressalva honesta: um snapshot feito antes de você excluir ainda contém o que foi excluído até ele expirar',
	'legal.privacy.backupsAreWhateverYouConfigured':
		'Backups são o que você configurou; mais ninguém tem uma cópia.',
	'legal.privacy.betterAuthSessionToken': 'better-auth.session_token',
	'legal.privacy.confirmationAndPasswordResetMessagesGo':
		'Mensagens de confirmação e redefinição de senha saem por um servidor SMTP com o qual esta\n\t\tinstância está configurada. Ele vê seu endereço e o texto dessas mensagens.',
	'legal.privacy.cookies': 'Cookies',
	'legal.privacy.days': 'dias',
	'legal.privacy.everythingYouWriteBlocksTasks':
		'Tudo o que você escreve: blocos, tarefas, metas, entradas de diário, cadernos, pessoas, hábitos, ideias,\n\t\tcompras, citações, e os números que qualquer plugin que você conectar enviar.',
	'legal.privacy.ifYouSubscribeHandlesThe':
		'Se você assinar, a {provider} cuida da transação como merchant of record. Ela vê seus dados de cobrança; esta instância nunca vê, e guarda só os identificadores necessários para saber que sua assinatura está ativa.',
	'legal.privacy.inOneSqliteDatabaseOn': 'Em um banco de dados SQLite em',
	'legal.privacy.itIsReadBy': '. É lido por uma pessoa.',
	'legal.privacy.lastUpdated': 'Atualizado pela última vez em {updated}.',
	'legal.privacy.mail': 'E-mail.',
	'legal.privacy.oneCalled': 'Um, chamado',
	'legal.privacy.ontoplanoHoldsADiaryYour':
		'o ontoplano guarda um diário, suas notas, suas metas e o registro dos seus dias. É por isso que esta página\n\té específica em vez de um modelo genérico: o que você guarda aqui é do tipo que você não gostaria\n\tque fosse lido.',
	...
	'legal.privacy.theAddressYouConnectedFrom':
		'O endereço de onde você se conectou, junto com esses eventos, pelo tempo que forem mantidos.',
	'legal.privacy.theMachineYouInstalledIt': 'a máquina em que você a instalou',
	'legal.privacy.thePersonRunningThisInstance':
		'A pessoa que administra esta instância pode, tecnicamente — é o banco de dados dela. Não há como entrar como sua conta: as páginas de administração listam contas e eventos genéricos, como um cadastro ou uma mudança de plano, e nada do que você escreveu. Mais ninguém tem acesso.',
	'legal.privacy.theServerThatRunsThis': 'o servidor que roda esta instância',
	'legal.privacy.thereIsNoAnalyticsNo':
		'Não há análise de uso, não há publicidade, não há script de terceiros, e nada é vendido a ninguém.',
	'legal.privacy.whatIsStored': 'O que é guardado',
	'legal.privacy.whereItIsStored': 'Onde é guardado',
	'legal.privacy.whichHappensWithin': ', o que acontece em até',
	'legal.privacy.whichIsWhatKeeps':
		', que é o que mantém você conectado. Não é\n\tcompartilhado, nem lido por mais ninguém, e não há nada a consentir porque nada mais\n\té feito com ele. Sem cookies de rastreamento, sem aviso de cookies.',
	'legal.privacy.whoCanSeeIt': 'Quem pode ver isso',
	'legal.privacy.whoElseIsInvolved': 'Quem mais está envolvido',
	'legal.privacy.whoeverAdministersTheMachineWhich': 'Quem administra a máquina, que é você.',
	'legal.privacy.writeTo': 'Escreva para',
	'legal.privacy.yourEmailAddressAndName':
		'Seu endereço de e-mail e seu nome, porque uma conta precisa de uma forma de entrar nela.',
	'legal.refunds.aCardIsAsked':
		'. Um cartão é pedido no início para que a assinatura possa começar quando o período de teste terminar, e nada é cobrado até lá',
	'legal.refunds.aNewAccountRunsFor':
		'Uma nova conta funciona por {trialDays} dias sem pagar{for}. Cancelar nesses dias não custa nada, porque nada foi cobrado.',
	'legal.refunds.aRefundedOrEndedSubscription':
		'Uma assinatura reembolsada ou encerrada deixa tudo o que você escreveu\n\t\tonde está, legível e exportável com um clique. Você só não pode adicionar mais nada até assinar\n\t\tde novo — e como o código é aberto, você pode rodar sua própria cópia e levar a exportação com\n\t\tvocê.',
	'legal.refunds.afterThat': 'Depois disso',
	'legal.refunds.andNoCardIsAsked': 'e nenhum cartão é pedido',
	'legal.refunds.askWithinSevenDaysOf':
		'Peça em até sete dias da cobrança e o valor total volta para o cartão de origem.',
	'legal.refunds.beforeTheFirstCharge': 'Antes da primeira cobrança',
	'legal.refunds.brazilianConsumerLawThe':
		'A lei brasileira de defesa do consumidor — o Código de Defesa do Consumidor, artigo 49 — dá a quem compra\n\t\talgo fora de uma loja física sete dias a partir da compra para desistir e ser reembolsado\n\t\tintegralmente, sem precisar dar um motivo. Isso vale aqui, e é respeitado independentemente de\n\t\ta conta ter sido usada nesse período.',
	'legal.refunds.cancelWheneverYouLikeThe':
		'Cancele quando quiser: a assinatura para de renovar e a conta continua funcionando até\n\t\to fim do período já pago. Essa parte não é reembolsada proporcionalmente, porque é tempo\n\t\tque você ainda pode usar.',
	'legal.refunds.howToAsk': 'Como pedir',
	'legal.refunds.lastUpdated': 'Atualizado pela última vez em {updated}.',
	'legal.refunds.nothingIsDeleted': 'Nada é excluído.',
	...
	'legal.refunds.thisInstanceIsSomebodySOwn':
		'Esta instância é a cópia particular de alguém do ontoplano. Ela não recebe pagamentos, então não há\n\t\tnada a reembolsar aqui.',
	'legal.refunds.twoExceptionsHonouredWithoutArgument':
		'Duas exceções, respeitadas sem discussão: uma cobrança que você não pretendia — uma renovação que você ia\n\t\tcancelar, uma segunda assinatura comprada por engano — e um período em que o serviço estava\n\t\tinutilizável. Escreva e você é reembolsado.',
	'legal.refunds.whatARefundDoesTo': 'O que um reembolso faz com a conta',
	'legal.refunds.whoeverRunsThisInstance': 'quem administra esta instância',
	'legal.refunds.writeToFromThe':
		'Escreva para {instance}, a partir do endereço da conta, e diga qual cobrança. Não há formulário.',
	'legal.terms.aMonth': 'um mês',
	'legal.terms.aNewAccountGets': 'Uma nova conta recebe',
	'legal.terms.anAccountDoingOneOf':
		'Uma conta que fizer uma dessas coisas pode ser suspensa. Se isso acontecer, você será informado do motivo, e sua\n\texportação continua funcionando.',
	'legal.terms.andIsAskedFor':
		', e um cartão é pedido no início para que a assinatura possa começar quando o período de teste terminar',
	'legal.terms.andIsNotAskedFor': 'e nenhum cartão é pedido',
	'legal.terms.asMerchantOfRecord':
		'como merchant of record — ela recebe o pagamento, emite a nota fiscal e cuida dos impostos.',
	'legal.terms.cancelAnyTimeTheSubscription':
		'Cancele quando quiser; a assinatura vai até o fim do período que você pagou.',
	'legal.terms.daysFree': 'dias grátis',
	'legal.terms.deleteTheAccountFromSettings':
		'Exclua a conta em Configurações → Conta quando quiser. Sem aviso prévio, sem troca de e-mails, sem\n\tperíodo de retenção.',
	'legal.terms.endingIt': 'Encerrando',
	'legal.terms.everythingYouWroteStaysWhere':
		'Tudo o que você escreveu continua onde está, continua legível\n\te continua exportável — você só não pode adicionar mais nada até assinar de novo. E como o código\n\té aberto, você sempre pode rodar sua própria cópia e levar a exportação com você.',
	'legal.terms.ifAChargeWasWrong':
		'Se uma cobrança estiver errada, escreva para {instance} e ela será reembolsada.',
	'legal.terms.itCosts': '. Custa',
	'legal.terms.keepYourPasswordToYourself':
		'Mantenha sua senha só para você, e avise {instance} se achar que mais alguém a tem.',
	'legal.terms.lastUpdated': 'Atualizado pela última vez em {updated}.',
	'legal.terms.nothingIsDeletedWhenIt': 'Nada é excluído quando ela termina.',
	'legal.terms.ontoplanoIsOpenSourceUnder':
		'O ontoplano é de código aberto sob a AGPL-3.0, e você pode rodar sua própria cópia — é\n\tpara isso que ela serve. A licença cobre o código, não o nome do projeto, então um fork sai\n\tcom um nome próprio.',
	'legal.terms.or': ', ou',
	'legal.terms.paying': 'Pagando',
	'legal.terms.paymentIsHandledBy': '. O pagamento é processado por',
	'legal.terms.resellAccessToSomebodyElseS': 'Revender acesso à conta de outra pessoa.',
	...
	'legal.terms.theSoftwareIsProvidedAs':
		'O software é fornecido como está, sem garantia. A responsabilidade, onde não puder ser excluída, é limitada ao que você pagou nos últimos doze meses. Disputas vão para os tribunais de {jurisdiction}.',
	'legal.terms.theseAreTheTermsFor':
		'Estes são os termos para usar esta instância do ontoplano, administrada por {operator}. Usá-la significa concordar com eles. Eles são curtos porque não há muito a dizer.',
	'legal.terms.thisIsASelfHostedInstance':
		'Esta é uma instância autogerenciada: ela fica no ar quando a máquina em que roda está no ar, o que é responsabilidade sua, e de mais ninguém.',
	'legal.terms.thisIsRunByOne':
		'Isto é administrado por uma pessoa em uma infraestrutura comum. Não é um banco. Espere que fique no ar quase o tempo todo, espere reinícios ocasionais para atualizações, e não espere compensação se ficar fora do ar por uma tarde — não há garantia de disponibilidade aqui, e seria desonesto escrever uma. O que se promete, em vez disso, é que seus dados são copiados para fora da máquina, que você pode exportá-los a qualquer momento sem pedir, e que se esta instância algum dia for encerrada, você será avisado com bastante antecedência, com sua exportação ainda funcionando.',
	'legal.terms.useItToAttackThe':
		'Usá-la para atacar o servidor em que ela roda, ou o de qualquer outra pessoa.',
	'legal.terms.whatIsPromisedAboutIt': 'O que se promete sobre ela funcionar',
	'legal.terms.whatYouMayNotDo': 'O que você não pode fazer com ela',
	'legal.terms.whatYouWriteHereBelongs':
		'O que você escreve aqui pertence a você. Nada nestes termos dá a ninguém licença para usar seu\n\tconteúdo para qualquer coisa; ele é guardado só para poder ser mostrado de volta a você.',
	'legal.terms.whoeverRunsThisInstance': 'quem administra esta instância',
	'legal.terms.youWillBeEmailedTwo':
		'Você receberá um e-mail dois dias antes da primeira cobrança, e pode cancelar com um clique\n\t\tdentro do app até o momento em que ela acontecer.',
	'login.closedAlphaWarning':
		'O Ontoplano está em alfa fechado — se cadastrar exige um código de convite. Contas criadas agora são de verdade: seus dados ficam, durante o alfa e depois dele.',
	'login.confirmPassword': 'Confirmar senha',
	'login.createAccount': 'Criar conta',
	'login.email': 'E-mail',
	'login.familyPlan': 'Plano família.',
	'login.forgotPassword': 'Esqueci a senha',
	'login.haveAnAccount': 'Já tem uma conta?',
	'login.iHaveAnInvitationCode': 'Tenho um código de convite',
	'login.invitationCode': 'Código de convite',
	'login.noAccount': 'Não tem conta?',
	'login.password': 'Senha',
	'login.passwordsDoNotMatch': 'As duas senhas não são iguais.',
	'login.privacy': 'Privacidade',
	'login.refunds': 'Reembolsos',
	'login.register': 'Cadastrar',
	'login.reset.chooseANewPassword': 'Escolha uma nova senha',
	'login.reset.confirm': 'Confirmar',
	'login.reset.newPassword': 'Nova senha',
	'login.reset.setPassword': 'Definir senha',
	'login.reset.signInPage': 'página de entrada',
	'login.reset.thisLinkHasNoToken':
		'Este link não tem um token. Links de redefinição funcionam uma vez — peça um novo na',
	'login.sendResetLink': 'Enviar link de redefinição',
	'login.signIn': 'Entrar',
	'login.terms': 'Termos',
	'login.thisIsTheFirstAccount': 'Esta é a primeira conta nesta instância, então ela é dona dela.',
	'login.thisServerHasNoMail':
		'Este servidor não tem e-mail configurado, então o link vai para o log.',
	'login.useADifferentOntoplano': 'Usar outro ontoplano',
	'login.verify.aConfirmationMailWentTo': 'Um e-mail de confirmação foi enviado para',
	'login.verify.clickOnItsLink': '. Clique no\n\t\t\tlink dele para entrar.',
	'login.verify.confirmYourAddress': 'Confirme seu endereço',
	'login.verify.sendItAgain': 'Enviar de novo',
	'login.verify.sentCheckMailbox': 'Enviado — confira sua caixa de entrada.',
	'login.verify.signOut': 'Sair',
	'login.verify.wrongAddress': 'Endereço errado?',
	...
	'mail.weeklyReview.off.goToOntoplano': 'Ir para o ontoplano',
	...
	'media.fold': 'Recolher {name}',
	'media.gallery.id.addPicturesAppearInGrid':
		'Adicione fotos e elas aparecem numa grade. Até {kilobytes}KB cada nesta instância.',
	'media.importCount': 'Importar {count}',
	'media.importingProgress': 'Importando {done}/{total}…',
	'media.newRecording': 'Nova gravação',
	'media.noRecordingInThatRequest': 'Nenhuma gravação nessa solicitação.',
	...
	'notebookDetail.addWithTodos': {
		...
		other: 'Adicionar com {count} tarefas'
	},
	'notebookDetail.alreadyDone': 'feita',
	...
	'notebookDetail.archivedCount': 'Arquivadas ({count})',
	...
	'notebookDetail.makeCountTodos': 'Criar {count} tarefas',
	'notebookDetail.makeTodosOfTheCheckboxes': 'Criar tarefas das caixas de seleção',
	'notebookDetail.makeTodosOfThisNote': 'Criar tarefas desta nota',
	'notebookDetail.newGoal': 'Nova meta',
	'notebookDetail.newNote': 'Nova nota',
	'notebookDetail.newTask': 'Nova tarefa',
	...
	'notebookDetail.orderNotesBy': 'Ordenar notas por',
	...
	'notebookDetail.theNoteStaysAsItIs': 'A nota permanece como está.',
	...
	'notebooks.createNotebook': 'Criar caderno',
	'notebooks.deleteTheNotebook': 'Excluir o caderno',
	'notebooks.deleteThisNotebook': 'Excluir este caderno?',
	'notebooks.diary.addAnother': '+ Adicionar outra',
	'notebooks.diary.anaJoão': 'Ana, João',
	'notebooks.diary.anyoneThisWasAbout': 'Alguém a quem isso diz respeito.',
	'notebooks.diary.confirm': 'Confirmar?',
	'notebooks.diary.editEntry': 'Editar entrada',
	'notebooks.diary.edited': '· editado em {updatedAt}',
	'notebooks.diary.for': 'para {forDate}',
	'notebooks.diary.newEntry': 'Nova entrada',
	'notebooks.diary.newWins': 'Novas vitórias',
	'notebooks.diary.people': 'Pessoas',
	'notebooks.diary.postEntry': 'Publicar entrada',
	'notebooks.diary.saveWins': 'Salvar vitórias',
	'notebooks.diary.tagsCommasOrSpaces': 'tags, vírgulas ou espaços',
	'notebooks.diary.theJournalIsEmpty': 'O diário está vazio',
	'notebooks.diary.whateverHappenedTodayInAs':
		'O que aconteceu hoje, em quantas palavras você quiser.',
	'notebooks.diary.win': 'Vitória {i}',
	...
	'notebooks.id.atTheBottomOf': ', no fim da lista.',
	'notebooks.id.changeThePicture': 'Trocar a imagem',
	'notebooks.id.close': 'Fechar',
	'notebooks.id.closed': 'fechado',
	'notebooks.id.deleteTheNotebook': 'Excluir o caderno',
	'notebooks.id.deleteThisNotebook': 'Excluir este caderno?',
	'notebooks.id.editNotebook': 'Editar caderno',
	'notebooks.id.everyNewNoteStartsWith': 'Uma nota escrita aqui começa com estas',
	...
	'notebooks.id.larrAllNotebooks': '← Todos os cadernos',
	'notebooks.id.notesWithoutANotebook': 'Notas sem caderno',
	'notebooks.id.removeThePicture': 'Remover a imagem',
	'notebooks.id.reopen': 'Reabrir',
	'notebooks.id.shareWithFamily': 'Compartilhar com a família',
	...
	'notebooks.ideas.applied2': 'aplicada',
	'notebooks.ideas.appliedNote': 'Nota de aplicação',
	'notebooks.ideas.appliedUndo': 'Aplicada — desfazer',
	'notebooks.ideas.confirm': 'Confirmar?',
	'notebooks.ideas.editIdea': 'Editar ideia',
	'notebooks.ideas.editNote': 'Editar nota',
	'notebooks.ideas.edited': '· editado em {updatedAt}',
	'notebooks.ideas.favourite': 'Favorito',
	'notebooks.ideas.favourites': 'Favoritas',
	'notebooks.ideas.ideasAreTheThingsYou':
		'Ideias são as coisas que você esqueceria até se sentar para escrever.',
	'notebooks.ideas.markApplied': 'Marcar como aplicada',
	'notebooks.ideas.markAsFavorite': 'Marcar como favorito',
	'notebooks.ideas.newIdea': 'Nova ideia',
	'notebooks.ideas.noAppliedNoteYet': 'Ainda sem nota de aplicação.',
	'notebooks.ideas.noIdeasMatchTheCurrent': 'Nenhuma ideia corresponde aos filtros atuais',
	'notebooks.ideas.notApplied': 'Não aplicadas',
	'notebooks.ideas.notFavourite': 'Não favoritas',
	'notebooks.ideas.nothingCapturedYet': 'Nada registrado ainda',
	'notebooks.ideas.removeFavorite': 'Remover dos favoritos',
	'notebooks.ideas.saveIdea': 'Salvar ideia',
	'notebooks.ideas.whatDidYouApply': 'O que você aplicou?',
	...
	'notebooks.itsNotesTasksAndGoals':
		'Suas notas, tarefas e metas não serão excluídas. As tarefas e metas ficam onde estão, no\n\t\tplanejador e em Metas; as notas vão para',
	'notebooks.kitchenRenovation': 'Reforma da cozinha',
	...
	'notebooks.noNotebooksYet': 'Ainda sem cadernos',
	'notebooks.notesCount': { one: '{count} nota', other: '{count} notas' },
	'notebooks.notesWithoutANotebook': 'Notas sem caderno',
	'notebooks.nothingInItYet': 'nada nele ainda',
	...
	'notebooks.people.addAPictureOf': 'Adicionar uma foto de {name}',
	'notebooks.people.addPerson': 'Adicionar pessoa',
	'notebooks.people.addThePeopleWhoTurn':
		'Adicione as pessoas que aparecem no que você escreve, e cada menção a elas se junta aqui.',
	'notebooks.people.birthday': 'Aniversário',
	'notebooks.people.changeTheirPicture': 'Trocar a foto de {name}',
	'notebooks.people.editPerson': 'Editar pessoa',
	'notebooks.people.email': 'E-mail',
	'notebooks.people.howYouKnowThem': 'Como você conhece essa pessoa',
	'notebooks.people.kb': 'KB',
	'notebooks.people.mentionThemInADiary':
		'Mencione essa pessoa em uma entrada de diário e ela aparecerá aqui.',
	'notebooks.people.mentions': 'Menções',
	'notebooks.people.nbspFor': ' · para',
	'notebooks.people.newPerson': 'Nova pessoa',
	'notebooks.people.nobodySelected': 'Ninguém selecionado',
	'notebooks.people.nobodyYet': 'Ninguém ainda',
	'notebooks.people.nothingWrittenAboutYet': 'Nada escrito sobre {name} ainda',
	'notebooks.people.onTheDay': 'No dia',
	'notebooks.people.phone': 'Telefone',
	'notebooks.people.pickSomebodyToSeeEverything':
		'Escolha alguém para ver tudo o que você escreveu sobre a pessoa.',
	'notebooks.people.removeThePicture': 'Remover a foto',
	'notebooks.people.replaceThePicture': 'Substituir a foto',
	'notebooks.people.tellMeThatMorning': 'Avise-me naquela manhã',
	'notebooks.people.upTo': 'até',
	...
	'notebooks.tags.aTagWithNoColour': 'Uma etiqueta sem cor é desenhada simples.',
	...
	'notebooks.tasksCount': { one: '{count} tarefa', other: '{count} tarefas' },
	...
	'notebooks.widenOrNarrowTheList': 'Alargar ou estreitar a lista',
	'notebooks.workoutsCount': { one: '{count} workout', other: '{count} workouts' },
	'notifications.markAllRead': 'Marcar tudo como lido',
	'notifications.none': 'Nada ainda.',
	'notifications.open': 'Notificações, {count} não lidas',
	'notifications.openNone': 'Notificações',
	...
	'notify.noun.goalProgress': {
		one: '{count} progresso de meta',
		other: '{count} progresso de metas'
	},
	...
	'notify.noun.inventoryItem': {
		one: '{count} item de inventário',
		other: '{count} itens de inventário'
	},
	'notify.noun.item': { one: '{count} item', other: '{count} itens' },
	'notify.noun.itemAttributes': { one: '{count} campo de item', other: '{count} campos de item' },
	'notify.noun.ledger': { one: '{count} lançamento', other: '{count} lançamentos' },
	'notify.noun.location': { one: '{count} local', other: '{count} locais' },
	...
	'notify.noun.sortRule': {
		one: '{count} regra de classificação',
		other: '{count} regras de classificação'
	},
	'notify.noun.tag': { one: '{count} etiqueta', other: '{count} etiquetas' },
	'notify.noun.task': { one: '{count} tarefa', other: '{count} tarefas' },
	'notify.noun.toGoal': { one: '{count} vínculo de meta', other: '{count} vínculos de meta' },
	'notify.noun.win': { one: '{count} vitória', other: '{count} vitórias' },
	'notify.noun.workout': { one: '{count} treino', other: '{count} treinos' },
	'notify.noun.workoutCategory': {
		one: '{count} categoria de treino',
		other: '{count} categorias de treino'
	},
	'notify.noun.workoutMeasures': {
		one: '{count} medida de treino',
		other: '{count} medidas de treino'
	},
	'notify.noun.workoutSession': { one: '{count} sessão', other: '{count} sessões' },
	...
	'notify.verb.archive': 'arquivou',
	'notify.verb.cancel': 'cancelou',
	'notify.verb.change': 'alterou',
	'notify.verb.close': 'fechou',
	'notify.verb.cooked': 'cozinhou',
	'notify.verb.delete': 'excluiu',
	'notify.verb.describe': 'descreveu',
	'notify.verb.dismiss': 'dispensou',
	'notify.verb.drop': 'abandonou',
	'notify.verb.edit': 'editou',
	'notify.verb.favorite': 'favoritou',
	'notify.verb.file': 'arquivou em',
	'notify.verb.finish': 'concluiu',
	...
	'notify.verb.recolor': 'recoloriu',
	'notify.verb.record': 'gravou',
	'notify.verb.remind': 'criou um lembrete em',
	...
	'notify.verb.unlink': 'desvinculou',
	...
	'onboarding.blankDescription': 'Três categorias e uma semana vazia. Preencha do seu jeito.',
	'onboarding.remoteWorkerDescription':
		'Trabalho focado antes do almoço, tarefas administrativas depois, uma caminhada para fechar o dia.',
	'onboarding.studentDescription': 'Aulas de manhã, blocos de estudo depois, exercício no meio.',
	'ops.backups': 'Backups',
	...
	'ratings.ease': 'Facilidade',
	'ratings.howLittleEffortIt': 'Quão pouco esforço vai exigir',
	'ratings.howMuchYouWantTo': 'O quanto você quer fazer isso',
	'ratings.howSoonThisHasTo': 'Quão em breve isso precisa acontecer',
	...
	'ratings.whereItWouldSit': 'Posição entre as tarefas abertas, em ordem de prioridade',
	'recurrence.everyDay': 'Todo dia',
	'recurrence.everyNDays': { one: 'Todo dia', other: 'A cada {count} dias' },
	'recurrence.everyNWeeks': {
		one: 'Toda semana: {weekday}',
		other: 'A cada {count} semanas: {weekday}'
	},
	'recurrence.everyOtherWeek': 'A cada duas semanas: {weekday}',
	'recurrence.monthly': 'Dia {day} de cada mês',
	...
	'reminders.aSoundFile': 'Um arquivo de som',
	'reminders.ahead': 'Futuro',
	'reminders.alarmsOnThisPhone': {
		one: '1 alarme marcado neste celular',
		other: '{count} alarmes marcados neste celular'
	},
	'reminders.allowExactAlarms': 'Permitir alarmes exatos',
	'reminders.allowNotifications': 'Permitir notificações',
	'reminders.alreadyBeen': 'Já passou',
	...
	'reminders.atLeastMinutesFromNow':
		'Lembretes têm que ser pelo menos {count} minutos a partir de agora.',
	...
	'reminders.changeThisReminder': 'Mudar este lembrete',
	'reminders.channelSilenced':
		'Os lembretes estão configurados para chegar sem som neste celular. Eles ainda aparecem.',
	'reminders.checkNow': 'Checar agora',
	'reminders.checksAgainAt': 'Checa de novo {when}',
	'reminders.comingUp': 'Em breve',
	'reminders.confirm': 'Confirmar?',
	'reminders.couldNotReachInstance':
		'A última checagem não alcançou seu ontoplano — vai tentar de novo em breve, e o que já está marcado continua tocando.',
	...
	'reminders.firstOneAt': 'O primeiro é às {when}',
	'reminders.followTheKind': 'Seguir o tipo',
	'reminders.giveItALaterOne': 'Dê um horário mais tarde a ele.',
	'reminders.go': 'Ir',
	'reminders.hear': 'Ouvir {name}',
	'reminders.hearIt': 'Ouvir',
	'reminders.howFar': 'Até quando',
	'reminders.howManyDaysToCover': 'Quantos dias cobrir, até {maxDays}',
	'reminders.kb': '{bytes} KB',
	'reminders.lastCheckedAt': 'Última checagem {when}',
	'reminders.leaveTheNameEmptyAnd': 'Deixe o nome vazio e o nome do próprio arquivo é usado.',
	'reminders.localhost': 'localhost',
	'reminders.lookThatFar': 'Olhar até lá',
	'reminders.makeASound': 'Fazer um som',
	'reminders.makeHttpsLocal': 'make https-local',
	'reminders.neverChecked': 'Ainda não conseguiu checar',
	...
	'reminders.openThePhoneSSettings': 'Abrir as configurações do telefone',
	'reminders.optional': 'opcional',
	'reminders.or': 'ou',
	'reminders.past': 'Passado',
	'reminders.playASoundAsWell': 'Tocar um som além de mostrar. Desligado significa que só mostra.',
	'reminders.preferences': 'Preferências',
	...
	'reminders.sound': 'Som',
	'reminders.stopsThatOrSetsIt': 'interrompe isso, ou configura de novo.',
	'reminders.thatTimeHasAlreadyBeen': 'Esse horário já passou.',
	'reminders.thatTimeHasAlreadyBeen2': 'Esse horário já passou',
	'reminders.theLastDays': {
		one: 'O último {count} dia — o que já disparou.',
		other: 'Os últimos {count} dias — o que já disparou.'
	},
	'reminders.theNextDays': {
		one: 'O próximo {count} dia — tudo configurado, seja o que for.',
		other: 'Os próximos {count} dias — tudo configurado, seja o que for.'
	},
	'reminders.thisBrowserHasNoPush':
		'Este navegador não tem suporte a notificações push, então os lembretes só chegam com o ontoplano aberto.\n\t\t\t\t\tInstalar como app geralmente resolve isso.',
	'reminders.thisBrowserHasNotBeen':
		'Este navegador não tem permissão para te notificar, então os lembretes só chegam com esta página aberta.',
	'reminders.thisOneMakesASound': 'Este faz um som',
	'reminders.thisPhoneHasNotBeen':
		'Este telefone não tem permissão para te notificar, então os lembretes só chegam com o ontoplano aberto.',
	...
	'reminders.time': 'Hora',
	'reminders.upToRingtonesKbEach': 'Até {ringtones}, {kilobytes} KB cada. MP3, OGG ou WAV.',
	'reminders.whatHasAlreadyGoneOff': 'O que já disparou',
	'reminders.whatIsStillToCome': 'O que ainda está por vir',
	'reminders.whatMakesASound': 'O que faz um som',
	'reminders.whatThePhoneKnows': 'O que este celular sabe sobre te alcançar com o app fechado.',
	'reminders.whatTimeItShouldGo': 'A que horas deve disparar. Vazio significa {dayStart}.',
	'reminders.whatToSay': 'O que dizer',
	'reminders.whetherThisOneMakesA': 'Se este faz barulho, seja qual for o comportamento do tipo',
	'reminders.which': 'Qual',
	'reminders.whichDayItShouldGo': 'Em que dia deve disparar',
	'reminders.whichSoundThisOnePlays': 'Qual som este toca',
	'reminders.whichWayToLook': 'Em que direção olhar',
	'reminders.whyTheFloor':
		'O app procura lembretes novos a cada {count} minutos, então um marcado antes disso pode não chegar a tempo no seu celular.',
	'reminders.willThisRing': 'Isto vai tocar?',
	...
	'reportDialog.whereItGoes':
		'Vai para quem opera esta instância, levando sua conta, informações sobre o navegador que você usa, qual versão do app é esta, e o fato de ter vindo de {where}. Nenhum dado pessoal seu vai junto.',
	...
	'rooms.media.sections': 'Seções de mídia',
	'rooms.media.tabs.audios': 'Gravações',
	'rooms.media.tabs.gallery': 'Galeria',
	'rooms.media.title': 'Mídia',
	...
	'scopes.tagsRead': 'Ver as etiquetas que você usa e as cores que você deu a elas',
	'scopes.tagsWrite': 'Renomear suas etiquetas, colori-las e fundir duas em uma',
	...
	'search.kind.inventory': 'Inventário',
	...
	'sections.media.blurb':
		'Gravações e fotos. Diga algo sem digitar, e guarde suas fotos em álbuns.',
	'sections.media.label': 'Mídia',
	...
	'settings.account.everyOtherSignedInDeviceIs':
		'Todos os outros dispositivos conectados são desconectados.',
	'settings.account.everyRowBelongingToYou':
		'Todo registro seu vai junto. Isso não pode ser desfeito.',
	'settings.account.everyRowYouHaveMade':
		'Todo registro que você criou é apagado. A conta em si permanece. Isso não pode ser desfeito.',
	...
	'settings.account.everythingThisAccountOwnsAs':
		'Tudo o que esta conta tem, em JSON: planos, tarefas, diário, hábitos, metas, inventário, ideias e configurações.',
	...
	'settings.account.nothingChangesUntilTheLink':
		'Nada muda até que o link no e-mail de confirmação seja aberto.',
	...
	'settings.account.oneLinePerSignInAnything':
		'Uma linha por login. Qualquer um que você não reconhecer, desconecte.',
	...
	'settings.billing.aYear': '{currency} por ano',
	'settings.billing.againstTheCeilingsOnYour': 'Contra os limites do seu plano.',
	...
	'settings.billing.cardSavedTrialRunning': 'Cartão salvo — seus {count} dias estão correndo.',
	'settings.billing.confirmingYourPayment': 'Confirmando seu pagamento…',
	'settings.billing.endsOn': 'termina em {date}',
	'settings.billing.familyAccounts': 'Família — {seats} contas',
	'settings.billing.firstChargeOn': 'primeira cobrança em {date}',
	'settings.billing.forUpToAccountsOn': 'Para até {familySeats} contas em uma fatura:',
	'settings.billing.invitedRunsUntil':
		'Você foi convidado, e sua conta vale até {date}. Sem cartão, e nada foi cobrado.',
	...
	'settings.billing.trialRunsUntil': 'Seu período de teste vai até {date}.',
	...
	'settings.clock.auto': 'O que meu idioma usa — {example}',
	'settings.clock.heading': 'Relógio',
	'settings.clock.hint':
		'Como as horas são escritas. Seu idioma já tem uma resposta; mude se não for a sua.',
	...
	'settings.family.askedTheSeatIsTheirs':
		'Convidado — a vaga é dele assim que aceitar. Ele recebeu um e-mail sobre isso.',
	...
	'settings.family.offerIsWithdrawn': 'O convite foi retirado.',
	'settings.family.planCoversAccounts': 'Seu plano cobre {seats} contas — a sua e mais {more}.',
	'settings.family.sentEmailToOpenAccount':
		'Foi enviado um e-mail para abrir a conta e escolher uma senha.',
	...
	'settings.family.youAreOnTheirPlan': 'Você está no plano de {name}',
	...
	'settings.instance.daysAgo': 'há {count} dias',
	...
	'settings.instance.freeUntilDate': 'grátis até {date}',
	'settings.instance.freeWithNoEndDate': 'grátis sem data final',
	'settings.instance.handThisOverNow': 'Entregue agora — não é mostrado de novo.',
	'settings.instance.hiddenOnTheDemo': 'Escondido na demonstração.',
	'settings.instance.hoursAgo': 'há {count}h',
	...
	'settings.instance.minutesAgo': 'há {count} min',
	...
	'settings.instance.secondsAgo': 'há {count}s',
	...
	'settings.instance.thisProcessIsOlderThan':
		'Este processo é mais antigo que a versão que ele relata: a última implantação copiou os arquivos e nunca reiniciou o serviço.',
	...
	'settings.integrations.addThisToCodexConfig':
		'Adicione isso a ~/.codex/config.toml, e coloque a chave no seu perfil do shell para ela estar lá sempre.',
	...
	'settings.integrations.chat.answeringAs':
		'{provider}, chave {prefix}…, respondendo como {model}.',
	'settings.integrations.chat.asking': 'Perguntando…',
	'settings.integrations.chat.baseUrl': 'URL base',
	'settings.integrations.chat.blurb':
		'O chat responde com um modelo que você traz — escolha um provedor e cole uma chave sua.',
	'settings.integrations.chat.confirmRemove': 'Confirmar?',
	'settings.integrations.chat.couldNotAsk':
		'Não foi possível perguntar ao provedor. Verifique a chave e tente de novo.',
	'settings.integrations.chat.key': 'Chave de API',
	'settings.integrations.chat.loadModels': 'Perguntar ao provedor o que ele oferece',
	'settings.integrations.chat.loadModelsAgain': 'Perguntar de novo',
	'settings.integrations.chat.mayDelete': 'Deixar o chat apagar coisas',
	'settings.integrations.chat.mayDeleteCaution':
		'O que ele apaga some. Sem isso o chat cria e altera coisas, mas nunca as remove.',
	'settings.integrations.chat.model': 'Modelo',
	'settings.integrations.chat.noModels': 'Essa chave não alcança nenhum modelo de conversa.',
	'settings.integrations.chat.openChat': 'Abrir o chat',
	'settings.integrations.chat.pickAModel': 'Escolha um modelo',
	'settings.integrations.chat.pickFromTheList': 'Escolher da lista',
	...
	'settings.integrations.connections.anAiAssistantMcp': 'Um assistente de IA (MCP)',
	...
	'settings.integrations.connections.clear': 'Limpar',
	'settings.integrations.connections.confirm': 'Confirmar?',
	...
	'settings.integrations.connections.createdAutomaticallyWhenAnExternal':
		'Criado automaticamente quando um app externo declara um. Você escolhe como cada um é exibido.',
	'settings.integrations.connections.dashboard': 'Painel',
	'settings.integrations.connections.dataStreams': 'Streams de dados',
	'settings.integrations.connections.days': 'dias',
	'settings.integrations.connections.daysEmptyMeansNever': 'Dias. Vazio significa nunca.',
	'settings.integrations.connections.deleteStream': 'Excluir stream',
	...
	'settings.integrations.connections.eachDeliveryIsSignedWith':
		'Cada entrega é assinada com um segredo, mostrado uma vez quando o hook é criado, para que seu receptor confirme que é realmente este servidor.',
	'settings.integrations.connections.expires': '· expira',
	'settings.integrations.connections.expiresIn': 'Expira em',
	'settings.integrations.connections.gaveUpAfterRepeatedFailures': 'desistiu após falhas repetidas',
	'settings.integrations.connections.grantOnlyWhatTheApp':
		'Conceda só o que o app precisa. O que ficar desmarcado permanece fora de alcance.',
	'settings.integrations.connections.hookCreatedCopyIts':
		'Hook criado — copie o segredo agora, ele não será mostrado de novo.',
	'settings.integrations.connections.howOntoplanoSMcpServerWorks':
		'Como o servidor MCP do Ontoplano funciona, ferramenta por ferramenta →',
	...
	'settings.integrations.connections.noScopes': 'nenhum escopo',
	'settings.integrations.connections.noStreamsYet': 'Nenhum stream ainda',
	'settings.integrations.connections.noTokensYetCreate':
		'Nenhum token ainda — crie um para deixar outro app entrar',
	'settings.integrations.connections.noWebhooksYetAdd':
		'Nenhum webhook ainda — adicione um endereço para ser avisado quando algo acontecer',
	'settings.integrations.connections.nothingDeliveredYet': '· nada entregue ainda',
	...
	'settings.integrations.connections.putBack': 'Recolocar',
	'settings.integrations.connections.putItBack': 'Recolocar',
	'settings.integrations.connections.revoke': 'Revogar',
	'settings.integrations.connections.scope': 'escopo.',
	'settings.integrations.connections.secret': 'Segredo:',
	'settings.integrations.connections.shownOnceAtCreationIt':
		'Mostrado uma vez, na criação. Não pode ser recuperado depois.',
	'settings.integrations.connections.stopTellingMe': 'Parar de me avisar',
	'settings.integrations.connections.streams': 'streams',
	'settings.integrations.connections.streamsWrite': 'streams:write',
	'settings.integrations.connections.tellItWhen': 'Avise quando',
	'settings.integrations.connections.tellMeWhenThisHappens': 'Me avise quando isso acontecer',
	'settings.integrations.connections.theAppOnMyPhone': 'o app no meu telefone',
	...
	'settings.integrations.copyThis': 'Copiar isto',
	...
	'settings.integrations.forAnAssistantWithTerminal':
		'Para um assistente com terminal. Ele escreve a própria configuração e usa isso na próxima vez que iniciar.',
	'settings.integrations.hasTheFullFormWith':
		'tem o formulário completo, com todas as permissões e uma validade.',
	'settings.integrations.howToSetEachOne':
		'Como configurar cada um de forma permanente — a documentação',
	'settings.integrations.integrations': 'Integrações',
	'settings.integrations.itIsAlreadyInThe': 'Já está no texto abaixo.',
	'settings.integrations.itsConnectorScreenHasNowhere':
		'A tela de conectores dele não tem onde colocar uma chave, então isso passa pelo mcp-remote. Sem espaço depois dos dois-pontos — o Desktop corta o cabeçalho ao meio se você deixar um.',
	'settings.integrations.justTellIt': 'Só falar com ele',
	'settings.integrations.letAnAiAssistantUse': 'Deixe um assistente de IA usar este app',
	...
	'settings.integrations.pluginWillAskFor': 'ele vai pedir:',
	'settings.integrations.putBack': 'Recolocar',
	...
	'settings.integrations.tellItPrompt':
		'Eu uso o ontoplano — um app de organização da vida que você acessa por MCP.\n\nConfigure-se para usá-lo. Um servidor MCP é configurado antes de a sessão\ncomeçar, então saber o endereço não basta — escreva isso na sua própria\nconfiguração e reinicie.\n\n  Endereço:   {origin}/api/mcp\n  Transporte: streamable HTTP (stateless — sem sessão, sem GET)\n  Auth:       um cabeçalho "Authorization: Bearer" com a chave abaixo\n\nSe você for o Claude Code, é um comando só:\n\n  claude mcp add --scope user --transport http ontoplano {origin}/api/mcp \\\n    --header "Authorization: Bearer {key}"\n\nDepois de reiniciar, use sempre que eu perguntar sobre a minha semana, a minha\nlista de tarefas, o meu diário, os meus cadernos, a lista de compras ou as\nminhas receitas. Não mude nada na minha conta até eu pedir.\n\nChave: {key}',
	'settings.integrations.theCommandLine': 'A linha de comando',
	'settings.integrations.theDesktopApp': 'O app de mesa',
	'settings.integrations.thePlugin': 'O plugin',
	'settings.integrations.thenOnceInYourShellProfile':
		'depois, uma vez, no perfil do seu shell (~/.bashrc — zsh: ~/.zshrc):',
	'settings.integrations.thisSecretWillOnlyBe': 'Este segredo só será mostrado uma vez.',
	'settings.integrations.tickAtLeastOne':
		'Marque pelo menos uma coisa que o assistente pode fazer.',
	'settings.integrations.todaysPlan': 'O plano de hoje',
	'settings.integrations.twoLinesInsideClaudeCode':
		'Duas linhas dentro do Claude Code. Ele pede este endereço e sua chave, e guarda a chave no chaveiro do sistema.',
	'settings.integrations.whatItMayDo': 'O que ele pode fazer',
	'settings.integrations.whatYourAssistantsDid': 'O que seus assistentes fizeram',
	'settings.integrations.whichOneAreYouUsing': 'Qual você está usando?',
	'settings.integrations.widget.connectThisPhoneSWidget': 'Conectar o widget deste telefone',
	'settings.integrations.widget.connectedTakingYouBack': 'Conectado. Voltando para o widget…',
	'settings.integrations.widget.finishInTheApp': 'termine no app',
	'settings.integrations.widget.homeScreenWidget': 'Widget de tela inicial',
	'settings.integrations.widget.ifNothingHappens': 'Se nada acontecer,',
	'settings.integrations.widget.integrations': 'Integrações',
	'settings.integrations.widget.onTheWidgetSSetupScreen':
		'na tela de configuração do widget. É mostrado uma vez.',
	'settings.integrations.widget.openedInsideAppLinkComes':
		'Esta página abriu dentro do app, então o link de volta ao widget cai aqui de novo. Copie a chave e cole na tela de configuração do widget.',
	'settings.integrations.widget.openedInsideAppRatherThan':
		'Esta página abriu dentro do app em vez de num navegador. Conectar ainda funciona — você vai copiar a chave manualmente no final.',
	'settings.integrations.widget.orPasteTheKey': 'Ou cole a chave',
	...
	'settings.integrations.widget.youCanDisconnectItAny':
		'Você pode desconectá-lo a qualquer momento revogando a chave dele em',
	'settings.integrations.wiringUpAScriptA':
		'Vai conectar um script, um widget ou um calendário em vez disso?',
	'settings.integrations.write': 'Escrita',
	'settings.integrations.yourNewKey': 'Sua nova chave',
	'settings.integrations.yourWeek': 'Sua semana',
	'settings.integrations.yourWeekToDoListDiary':
		'Sua semana, lista de tarefas, diário, lista de compras ou o que você quiser, ao alcance de um assistente com quem você já conversa.',
	...
	'settings.locationAndTime.heading': 'Local e hora',
	'settings.locationAndTime.hint':
		'Onde você está e como você lê as horas. Todo o resto desta página muda depois que isto estiver certo.',
	...
	'settings.preferences.backToTheDefaults': 'Voltar ao padrão',
	'settings.preferences.blockedForThisSiteIts':
		'Bloqueado para este site. A permissão precisa ser mudada no navegador.',
	'settings.preferences.canRingHereWithThe':
		'pode tocar aqui com o app fechado. Ainda não configurado.',
	'settings.preferences.confirm': 'Confirmar?',
	'settings.preferences.currency': 'Moeda',
	'settings.preferences.currencyCode': 'Código da moeda',
	'settings.preferences.currencySaved': 'Moeda salva.',
	'settings.preferences.dashboard': 'Painel',
	'settings.preferences.dashboardLayoutSaved': 'Layout do painel salvo.',
	'settings.preferences.dayEndsAt': 'O dia termina às',
	'settings.preferences.dayStartsAt': 'O dia começa às',
	'settings.preferences.errorReports': 'Relatórios de erro',
	'settings.preferences.firstDayOfWeek': 'Primeiro dia da semana',
	'settings.preferences.generateTasksOn': 'Gerar tarefas em',
	'settings.preferences.hide': 'Ocultar',
	'settings.preferences.howTheWheelIsLaid': 'Como a roda é organizada',
	'settings.preferences.import': 'Importar',
	'settings.preferences.isNotACurrency':
		'{toUpperCase} não é um código de moeda que este navegador reconhece.',
	'settings.preferences.itsCode': 'O código dela',
	'settings.preferences.ldquoRdquo': '“{text}”',
	'settings.preferences.ldquoSystemRdquoUsesWhateverYourDevice':
		'“Sistema” usa o que estiver configurado no seu dispositivo.',
	'settings.preferences.mdash': '— {author}',
	'settings.preferences.menuSaved': 'Menu salvo.',
	'settings.preferences.money': 'Dinheiro',
	'settings.preferences.moveDown': 'Mover para baixo',
	'settings.preferences.moveUp': 'Mover para cima',
	'settings.preferences.nbsp': ' —',
	'settings.preferences.never': 'Nunca',
	'settings.preferences.noQuotesYet': 'Nenhuma citação ainda',
	'settings.preferences.notifications': 'Notificações',
	'settings.preferences.notificationsOnThisDevice': 'Notificações neste dispositivo',
	'settings.preferences.onForThisDevice': 'Ativado para este dispositivo.',
	'settings.preferences.onForThisPhone': 'Ativado para este telefone.',
	'settings.preferences.oneIsShownPerDay': 'Uma é mostrada por dia no painel.',
	'settings.preferences.onePerLine': 'Um por linha',
	'settings.preferences.oneQuotePerLineWhatever':
		'Uma citação por linha. O que vier depois do último travessão é o autor.',
	'settings.preferences.openThePhoneSSettings': 'Abrir as configurações do telefone',
	'settings.preferences.pLN': 'PLN',
	'settings.preferences.pasteAList': 'Colar uma lista',
	'settings.preferences.pickDarkColoursTheLabels':
		'Escolha cores escuras: os rótulos na roda são brancos. O planejador está sempre ativo.',
	'settings.preferences.plannerHours': 'Horário do planejador',
	'settings.preferences.plannerHoursSaved': 'Horário do planejador salvo.',
	'settings.preferences.plansAreWorthlessButPlanning':
		'Planos não valem nada, mas planejar é tudo. — EisenhowernO que é medido é gerenciado — Drucker',
	'settings.preferences.pricesWillRead': 'Os preços serão exibidos como',
	'settings.preferences.quote': 'Citação',
	'settings.preferences.quotes': 'Citações',
	'settings.preferences.reminders': 'Lembretes',
	'settings.preferences.remindersArriveWithTheApp':
		'Os lembretes chegam com o app fechado, pelos próprios alarmes do Android.',
	'settings.preferences.remindersArriveWithTheApp2':
		'Os lembretes chegam com o app fechado. Pedido uma vez por navegador.',
	'settings.preferences.remindersFrom': 'Lembretes de',
	'settings.preferences.resetToDefaults': 'Restaurar padrões',
	'settings.preferences.ringHereWithTheApp': 'tocar aqui com o app fechado.',
	'settings.preferences.ringOnThisPhone': 'Tocar neste telefone',
	'settings.preferences.saveLayout': 'Salvar layout',
	'settings.preferences.saveMenu': 'Salvar menu',
	'settings.preferences.send': 'Enviar',
	'settings.preferences.sendATest': 'Enviar um teste',
	'settings.preferences.setItUpAgain': 'Configurar de novo',
	'settings.preferences.settingItUp': 'Configurando…',
	'settings.preferences.show': 'Mostrar',
	'settings.preferences.stopRingingOnThisPhone': 'Parar de tocar neste telefone',
	'settings.preferences.style': 'Estilo',
	...
	'settings.preferences.thisPhoneWouldNotOpen':
		'Este telefone não conseguiu abrir. Configurações → Aplicativos → Ontoplano → Notificações.',
	'settings.preferences.threeLettersTheIso': 'Três letras — o código ISO, como PLN ou ZAR.',
	'settings.preferences.timezone': 'Fuso horário',
	'settings.preferences.turnOff': 'Desativar',
	'settings.preferences.turnOn': 'Ativar',
	'settings.preferences.u201cplansAreWorthlessButPlanning':
		'“Planos não valem nada, mas o planejamento é tudo.”',
	'settings.preferences.weekAndTimezone': 'Semana e fuso horário',
	'settings.preferences.weekSaved': 'Semana salva.',
	...
	'shortcut.askToDelete': 'Perguntar antes de excluir',
	'shortcut.askToDeleteCard': 'Perguntar antes de excluir cartão',
	...
	'shortcut.carryCardToNextColumn': 'Levar cartão para a próxima coluna',
	...
	'shortcut.editTag': 'Editar a etiqueta sob o cursor',
	'shortcut.editTheOneUnderThe': 'Editar o item sob o cursor',
	'shortcut.editTodo': 'Editar tarefa',
	'shortcut.expandCollapse': 'Expandir/recolher',
	'shortcut.markDoneReopen': 'Marcar como feito / reabrir',
	'shortcut.moveBetweenCards': 'Mover entre cartões',
	'shortcut.moveBetweenColumns': 'Mover entre colunas',
	'shortcut.moveBetweenTabs': 'Mudar de aba',
	'shortcut.navigateEntries': 'Navegar entre entradas',
	'shortcut.navigateHabits': 'Navegar entre hábitos',
	'shortcut.navigateIdeas': 'Navegar entre ideias',
	'shortcut.navigateItems': 'Navegar entre itens',
	'shortcut.navigateList': 'Navegar na lista',
	'shortcut.navigatePeople': 'Navegar entre pessoas',
	'shortcut.navigateSessions': 'Navegar entre sessões',
	...
	'shortcut.newDiaryEntry': 'Nova entrada de diário',
	'shortcut.newEntry': 'Nova entrada',
	'shortcut.newGoal': 'Nova meta',
	'shortcut.newHabit': 'Novo hábito',
	...
	'shortcut.numberKeysSetEase': 'Teclas numéricas definem a facilidade',
	'shortcut.numberKeysSetInterest': 'Teclas numéricas definem o interesse',
	'shortcut.numberKeysSetUrgency': 'Teclas numéricas definem a urgência',
	'shortcut.openTheCard': 'Abrir o cartão',
	'shortcut.openTheOneUnderThe': 'Abrir o item sob o cursor',
	'shortcut.previousGoal': 'Meta anterior',
	'shortcut.previousPage': 'Página anterior',
	'shortcut.previousPlaceInRoom': 'Lugar anterior nesta sala',
	'shortcut.pullOntoTodayPut': 'Puxar para hoje / devolver',
	'shortcut.resetZoomGrid': 'Redefinir zoom (grade)',
	'shortcut.selectDeselectMultiselect': 'Selecionar/desmarcar (seleção múltipla)',
	'shortcut.setTheActiveRating': 'Definir a avaliação ativa',
	'shortcut.switchDay': 'Trocar de dia',
	'shortcut.switchTodayGeneral': 'Trocar entre Hoje / Geral',
	'shortcut.switchWeek': 'Trocar de semana',
	'shortcut.toggleActive': 'Alternar ativo',
	'shortcut.toggleApplied': 'Alternar aplicado',
	'shortcut.toggleCategoryFilter': 'Alternar filtro de categoria',
	'shortcut.toggleDone': 'Alternar feito',
	'shortcut.toggleFavorite': 'Alternar favorito',
	'shortcut.toggleListGridView': 'Alternar visualização em lista/grade',
	'shortcut.toggleMultiselect': 'Alternar seleção múltipla',
	'shortcut.toggleReplenishFilter': 'Alternar filtro de reposição',
	'shortcut.toggleShortcutHelp': 'Alternar ajuda de atalhos',
	'shortcut.toggleShowArchived': 'Alternar exibição de arquivados',
	'shortcut.toggleShowBought': 'Alternar exibição de comprados',
	...
	'start.bothOfTodaySExportsAre':
		'As duas exportações de hoje já foram usadas — a próxima libera amanhã.',
	'start.downloadYourDataJson': 'Baixar seus dados (JSON)',
	'start.everyMonth': 'Mensal',
	'start.everyYear': 'Anual',
	...
	'start.ifNotTheFirstCharge': 'Se não, a primeira cobrança só chega em {firstChargeOn}.',
	'start.justMe': 'Só eu',
	'start.letMeSeeTheDemo': 'Quero ver a demonstração primeiro',
	'start.monthlyAMonth': 'Mensal — {currency} por mês',
	'start.nothingIsChargedToday': 'Nada é cobrado hoje',
	...
	'start.yourSubscriptionEnded': 'Sua assinatura terminou',
	'streamChart.dateCountPoints': { one: '{date}: {count} ponto', other: '{date}: {count} pontos' },
	'streamChart.inAgainstOutByMonth': '{inLabel} contra {outLabel}, por mês',
	...
	'streamChart.onceTheAppProducingThis':
		'Quando o app que produz esse fluxo enviar pontos, eles aparecem aqui.',
	'streamChart.sincePrevious': 'desde o anterior',
	'streamChart.thisStreamHasNoNumeric': 'Esse fluxo não tem valores numéricos.',
	...
	'tagFilter.all': 'Todas',
	'tagFilter.allHint': 'Com todas elas',
	'tagFilter.any': 'Qualquer',
	'tagFilter.anyHint': 'Com qualquer uma delas',
	'tagFilter.clear': 'Limpar',
	'tagFilter.filterByTag': 'Filtrar por etiqueta',
	'tagFilter.hide': 'Esconder',
	'tagFilter.howTheyCombine': 'Como se combinam',
	'tagFilter.keep': 'Mostrar',
	'tagFilter.nothingMatches': 'Nada corresponde a essas etiquetas.',
	'tagFilter.onlyWithTwo': 'Qualquer ou todas só faz diferença com duas etiquetas ou mais',
	'tagFilter.tags': 'Etiquetas',
	'tagFilter.untagged': 'Sem etiqueta',
	...
	'tasks.activities.categoriesCount': 'Categorias',
	'tasks.activities.clear': 'limpar',
	...
	'tasks.activities.hideCategories': 'Ocultar categorias',
	'tasks.activities.manageCategories': 'Gerenciar categorias',
	...
	'tasks.board.1Hour': '1 hora',
	'tasks.board.addCard': 'Adicionar cartão',
	'tasks.board.before': 'antes',
	'tasks.board.called': 'Chamado',
	...
	'tasks.board.easeFrom': 'Facilidade a partir de',
	'tasks.board.edit': 'Editar {title}',
	'tasks.board.filters': 'Filtros',
	'tasks.board.markDone': 'Marcar {title} como feito',
	'tasks.board.markNotDone': 'Marcar {title} como não feito',
	'tasks.board.minutes': 'Minutos',
	'tasks.board.minutesFull': '{count} min',
	'tasks.board.move': 'mover ·',
	'tasks.board.moveThisToAColumn': 'Mover para outra coluna',
	'tasks.board.movingPickAColumn': 'Movendo “{title}” — escolha uma coluna',
	'tasks.board.newCard': 'Novo cartão',
	'tasks.board.noCategory': 'Sem categoria',
	'tasks.board.notSaid': '— não dito —',
	'tasks.board.nothingHere': 'Nada aqui',
	'tasks.board.nothingWaiting': 'Nada em espera',
	...
	'tasks.board.showSkipped': 'Mostrar pulados',
	'tasks.board.sort': 'Ordenar',
	...
	'tasks.board.urgencyEaseInterest': 'Urgência, facilidade, interesse',
	'tasks.board.whatItWas': 'O que foi',
	'tasks.board.whatToShow': 'O que mostrar',
	...
	'tasks.plan.cancel': 'cancelar',
	'tasks.plan.clearExistingPlan': 'Limpar plano existente',
	'tasks.plan.comesBackAsOften': 'Volta — na frequência que você definir.',
	...
	'tasks.plan.day': 'Dia',
	'tasks.plan.delete': 'Excluir {name}',
	'tasks.plan.deleteConfirm': 'Excluir — confirmar?',
	'tasks.plan.deleteEveryWeekConfirm': 'Excluir toda semana — confirmar?',
	...
	'tasks.plan.happensOnceOnOneDay': 'Acontece uma vez, em um dia.',
	'tasks.plan.haveItComeBack': 'Faça-o voltar — toda semana, ou no ritmo que você escolher',
	'tasks.plan.howMuchToShow': 'Quanto mostrar',
	'tasks.plan.howMuchYouDid': 'Quanto você fez',
	'tasks.plan.howOften': 'Com que frequência',
	'tasks.plan.httpsCalendarGoogleComCalendarIcalBasicI':
		'https://calendar.google.com/calendar/ical/…/basic.ics',
	'tasks.plan.import': 'Importar',
	'tasks.plan.importCsv': 'Importar CSV',
	'tasks.plan.inGoogleCalendarSettings':
		'No Google Agenda: Configurações → a agenda → “Endereço secreto no formato iCal”.\n\t\t\t\t\t\t\t\tO Ontoplano só lê essa agenda; nada que você fizer aqui a altera.',
	'tasks.plan.itHappened': 'Aconteceu',
	'tasks.plan.itsCategory': 'A categoria dele',
	'tasks.plan.keepOnlyThisOccurrenceAnd': 'Manter apenas esta ocorrência e parar de repetir',
	'tasks.plan.label': 'Etiqueta: {label}',
	'tasks.plan.lastFetchFailed': 'Última busca falhou: {lastError}',
	...
	'tasks.plan.notAtAll': 'Não avisar',
	'tasks.plan.nowTapATimeFor': 'agora toque em um horário para “{title}”',
	'tasks.plan.ofEachMonth': 'de cada mês',
	...
	'tasks.plan.schemeName': 'Nome do esquema',
	'tasks.plan.schemes': 'Esquemas',
	'tasks.plan.scroll': '+rolagem)',
	'tasks.plan.selected': '{size} selecionados',
	...
	'tasks.plan.toDo': 'Tarefas',
	'tasks.plan.toMoveOrResizeJust': 'para mover ou redimensionar apenas a ocorrência deste dia ·',
	...
	'tasks.plan.work': 'Trabalho',
	'tasks.plan.workout': 'Treino',
	'tasks.plan.zoom': 'Zoom',
	'tasks.plan.zoomIn': 'Aumentar zoom',
	'tasks.plan.zoomIn2': 'Aumentar zoom (+)',
	'tasks.plan.zoomOut': 'Diminuir zoom',
	'tasks.plan.zoomOut2': 'Diminuir zoom (-)',
	'tasks.review.aReviewNeedsAWeek':
		'Uma revisão precisa de uma semana com algo nela. Tente a semana anterior, ou planeje esta.',
	'tasks.review.answerOneAndItMoves': 'Responda um e ele vem para cá.',
	'tasks.review.applyEveryAnswer': 'Aplicar todas as respostas',
	'tasks.review.askAboutItAgain': 'Perguntar de novo',
	'tasks.review.askAboutTitleAgain': 'Perguntar de novo sobre {title}',
	'tasks.review.deleteIt': 'Excluir isto?',
	'tasks.review.done': 'Feitos ({count})',
	'tasks.review.editTheNote': 'Editar a nota',
	'tasks.review.everyOneOfThemHas': 'Todos eles têm uma resposta. Salve abaixo.',
	'tasks.review.everythingYouPlannedYouDid': 'Tudo que você planejou, você fez',
	'tasks.review.giveItA': '{title}: dar um dia',
	'tasks.review.giveItADay': 'Dar um dia',
	'tasks.review.goalsYouTouched': 'Metas que você tocou',
	'tasks.review.hoursAbbrev': '{count}h',
	'tasks.review.hoursMinutesAbbrev': '{hours}h {minutes}min',
	'tasks.review.itDidNotActually': '{title} não aconteceu de verdade',
	'tasks.review.itDidNotActuallyHappen': 'Não aconteceu de verdade',
	'tasks.review.itDidNotHappen': 'Não aconteceu',
	'tasks.review.itHappenedAfter': '{title}: aconteceu, afinal',
	'tasks.review.itHappenedAfterAll': 'Aconteceu, afinal',
	...
	'tasks.review.noGoalMovedYet': 'Nenhuma meta avançou ainda',
	'tasks.review.nobodyHasTouchedThese':
		'Ninguém mexeu nisso nos últimos {months} meses. Ainda vale?',
	'tasks.review.noneOfThem': '{length} {answers}, nenhuma delas escrita ainda.',
	'tasks.review.notesAboutTheWeek': 'Notas sobre a semana',
	'tasks.review.nothingHereHasHappenedYet':
		'Nada aqui aconteceu ainda. Salve para escrever tudo de uma vez.',
	'tasks.review.nothingIsTickedOffYet': 'Nada foi marcado ainda',
	...
	'tasks.review.planned': 'planejado.',
	'tasks.review.putItBackNothing': 'Devolver — nada aconteceu ainda',
	'tasks.review.putItOnThatDay': 'Colocar nesse dia',
	...
	'tasks.review.skipped2': 'pulado.',
	'tasks.review.skippedCount': 'Pulados ({count})',
	'tasks.review.someday': 'Algum dia',
	'tasks.review.stillHere': 'Ainda aqui',
	'tasks.review.stillReal': 'Ainda vale',
	'tasks.review.stillRunning': '· ainda em andamento',
	'tasks.review.theDayItShouldBe': 'O dia em que deve ser feito',
	'tasks.review.theOnesYouSaidNoTo':
		'Aqueles a que você disse não. Pergunte de novo para devolvê-lo às questões em aberto.',
	'tasks.review.theWeek': 'A semana',
	'tasks.review.thisWeek': 'Esta semana',
	'tasks.review.thisWeekIsStillRunning':
		'Esta semana ainda está em andamento — isto se preenche à medida que você marca as coisas como feitas.',
	'tasks.review.toCommit': '{length} {answers} para confirmar',
	'tasks.review.undoTheAnswerFor': 'Desfazer a resposta para {title}',
	'tasks.review.untold': 'Sem resposta ({count})',
	'tasks.review.week': 'Semana {number} de {year}',
	'tasks.review.whatDidNotHappen': 'O que não aconteceu',
	'tasks.review.whatHappened': 'O que aconteceu',
	'tasks.review.whatWentWellWhatDid':
		'O que deu certo, o que não deu, o que você vai fazer diferente…',
	'tasks.review.whatYouHaveDecided': 'O que você decidiu',
	'tasks.review.whatYouSkipped': 'O que você pulou',
	...
	'todoRows.batchDelete': 'Excluir tarefas selecionadas',
	'todoRows.batchNotebook': 'Mover tarefas selecionadas',
	...
	'todoRows.clearSelection': 'Limpar seleção',
	...
	'todoRows.done': 'Feito',
	'todoRows.doneAgo': 'Concluída {when} — {ago}',
	...
	'todoRows.removeLabels': 'Etiquetas a remover',
	'todoRows.saved': 'Salvo',
	'todoRows.searchTheseTasks': 'Buscar nestas tarefas',
	'todoRows.selectMany': 'Selecionar várias',
	'todoRows.selectTask': 'Selecionar {title}',
	'todoRows.selectVisible': 'Selecionar todas as tarefas visíveis',
	'todoRows.selectedCount': '{count} selecionadas',
	'todoRows.selectionKeys': 'Navegue com j/k; selecione com Espaço; cancele com Escape.',
	'todoRows.setTheRatings': 'Definir urgência, facilidade e interesse',
	...
	'todoRows.showingCount': { one: '{count} tarefa à vista', other: '{count} tarefas à vista' },
	...
	'todoRows.whatYouFinishedMostRecently':
		'O que você terminou mais recentemente — pressione para os mais recentes',
	'todoRows.writtenDown': 'Anotada {when}',
	'tour.aCategoryFridgeBathroom':
		'Uma categoria — geladeira, banheiro, escrivaninha — é o que faz a lista acompanhar o percurso pela casa.',
	'tour.aCurrentAccountIsOne':
		'Uma conta corrente é uma, um cartão de crédito é outra. Mantê-los separados é o que faz de "quanto custou o cartão" uma pergunta com resposta.',
	'tour.aDayAndASentence':
		'Um dia e uma frase, e um horário se você quiser. Chega ao seu celular com o app fechado, como todo o resto.',
	'tour.aFewLinesAboutThe':
		'Algumas linhas sobre a semana que acabou de terminar, e uma decisão sobre tudo o que ela deixou em aberto.',
	'tour.aGoalHasAHorizon':
		'Uma meta tem um horizonte — este mês, este ano, a década — e um progresso que você conta ou define manualmente.',
	'tour.aGoodHabitCountsThe':
		'Um bom hábito conta os dias em que você o fez. Um mau hábito conta os dias em que você não o fez.',
	...
	'tour.aWeekYouCanLay': 'Uma semana que você pode remontar',
	'tour.aWorkoutIsAName':
		'Um treino é um nome, um tipo e um plano. Escreva-o aqui uma vez, depois solte-o em um dia como faria com uma refeição.',
	'tour.aYearOfAHabit':
		'Um ano de um hábito de relance. Uma falha nele diz mais que qualquer número.',
	'tour.account': 'Conta',
	'tour.activities': 'Atividades',
	'tour.albumsNotFolders': 'Álbuns, não pastas',
	'tour.anActivityYouHaveStopped':
		'Uma atividade que você parou fica inativa, e tudo o que você fez nela permanece no histórico.',
	'tour.anIngredientIsAShopping': 'Um ingrediente é um item de compra',
	'tour.andOneAboutNothing': 'E uma sobre nada',
	'tour.andWhatItLooksLike': 'E como ela fica',
	...
	'tour.boughtAndBackAgain': 'Comprado, e de volta de novo',
	'tour.catchItNowJudgeIt': 'Capture agora, julgue depois',
	'tour.categoriesAreTheColours': 'Categorias são as cores',
	'tour.categoriesWashTheRowIn':
		'Categorias tingem a linha inteira com sua cor, e cada linha tem exatamente uma; tags se sobrepõem e ficam ao lado. Ambas são padrões que você escreve uma vez, na aba Regras.',
	'tour.clickHereIfYouEver': 'Clique aqui se precisar desta ajuda',
	'tour.closingAWeek': 'Fechando uma semana',
	'tour.copyARecipeFromWherever':
		'Copie uma receita de onde você a encontrou e cole o texto inteiro. Os ingredientes e o modo de preparo são extraídos dele.',
	'tour.diary': 'Diário',
	'tour.diaryEntriesAreWhatHappened':
		'Entradas do diário são o que aconteceu; um caderno é o que você está elaborando.',
	'tour.doneAndPutAway': 'Feito, e guardado',
	'tour.dragACardOrCarry': 'Arraste um cartão, ou leve-o com você',
	...
	'tour.entriesGoalsPeopleRecipesIdeas':
		'Entradas, metas, pessoas, receitas, ideias. Uma caixa sobre tudo isso.',
	...
	'tour.everythingShowsNothingMakesA':
		'Tudo aparece; nada faz barulho a menos que você diga aqui. Envie seus próprios sons e dê um para cada tipo.',
	'tour.everythingWithATimeOn': 'Tudo que tem um horário',
	'tour.everythingYouHaveWritten': 'Tudo o que você escreveu',
	...
	'tour.importTheBankU2019sOwnExport':
		'Importe o próprio extrato do banco e as linhas caem aqui, sem duplicatas — o mesmo arquivo duas vezes não adiciona nada. Qualquer coisa que o banco ainda não publicou você pode escrever manualmente.',
	'tour.ingredientsStepsAndACook':
		'Ingredientes, modo de preparo, e um modo de cozinhar que mantém a tela acesa enquanto você segue a receita.',
	...
	'tour.markASessionDoneTo':
		'Marque uma sessão como feita para registrá-la. Arquive uma que você parou de fazer — o histórico dela permanece; excluir é só para uma adicionada por engano.',
	...
	'tour.oneLedgerPerPlaceMoney': 'Um registro para cada lugar por onde o dinheiro passa',
	...
	'tour.oneSetOfLabelsFor': 'Um só conjunto de etiquetas para tudo',
	...
	'tour.renameOneAndItChanges': 'Renomeie, dê cor, remova',
	...
	'tour.tags': 'Etiquetas',
	'tour.tagsAndPeopleAsYou': 'Tags e pessoas, enquanto você escreve',
	'tour.tagsAreFreeFormInvent':
		'Tags são livres — invente uma e ela passa a existir. Nomear uma pessoa vincula a entrada a ela.',
	'tour.tagsCutAcross': 'Tags atravessam tudo',
	'tour.takeItWithYou': 'Leve com você',
	'tour.taskSelection':
		'Selecione várias para transformar as caixas em círculos. Selecione tarefas visíveis para mudar o estado, adicionar ou remover etiquetas, mover para um caderno ou confirmar a exclusão. Filtros limpam seleções ocultas.',
	...
	'tour.theNamedThingsYouKeep': 'As coisas com nome que você continua fazendo',
	'tour.theRestFillsInAs': 'O resto se preenche à medida que você escreve sobre eles.',
	...
	'tour.theThingsYouDoAnd': 'As coisas que você faz, e as que não faz',
	'tour.theWeekAndTheArrows':
		'A semana e as setas que a movem, à esquerda; grade ou lista, e o que adicionar, à direita.',
	'tour.themeTheDayYourWeek':
		'Tema, o dia em que sua semana começa, quais seções você mantém e de que cor elas são. Sua conta e seus dados também estão aqui.',
	'tour.theyHaveANameA':
		'Elas têm um nome, um aniversário e uma página só sua, então “tudo sobre a Ana” tem para onde ir.',
	'tour.thisIsOntoplano': 'Isto é o ontoplano',
	'tour.threeGoodThingsAboutThe':
		'Três coisas boas sobre o dia, uma linha cada. A entrada mais curta que vale a pena guardar, para os dias em que você não vai escrever mais que isso.',
	'tour.threeOptionalNumbersOnEvery':
		'Três números opcionais em cada cartão, de um a cinco. Ordene ou filtre o quadro por qualquer um deles; o histórico e a revisão os leem depois.',
	'tour.threeWins': 'Três vitórias',
	'tour.tickingSomethingOffInventoryStarts':
		'Marcar algo do inventário faz com que ele comece a acabar de novo. z adia o que você não quer pensar este mês.',
	'tour.toDo': 'Tarefas',
	'tour.todayAsCards': 'Hoje, em cartões',
	'tour.todayIsTheDayIn':
		'Hoje é o dia à sua frente. A fazer é tudo o que você anotou sem data; puxar um para hoje dá uma data a ele.',
	'tour.todayOrEverythingElse': 'Hoje, ou tudo o mais',
	'tour.tokensForProgramsThatRead':
		'Tokens para programas que leem ou escrevem em seu nome, um link de calendário, e os dados que outros apps enviam.',
	'tour.twoListsOnePage': 'Two lists, two tabs',
	'tour.typeAWordYouRemember': 'Digite uma palavra que você lembra',
	...
	'tour.whatTheWeekStartsOn':
		'Em que dia a semana começa, como ela se parece, quais seções você mantém, e o que aparece no painel.',
	'tour.whatTodayLooksLike': 'Como hoje se parece',
	...
	'tour.yourAccountAndYourData': 'Sua conta, e seus dados',
	'tour.yourAccountSearchTheRooms':
		'Sua conta, a busca, as seções, o início, e um botão para anotar algo.',
	'tour.yourOwnDivisionsWithYour':
		'Suas próprias divisões, com suas próprias cores. Uma meta pertence a uma delas.',
	'tour.yourRoomsYourOrderYour': 'Suas seções, sua ordem, suas cores',
	'tour.yourWeekYourGoalsAnd':
		'Sua semana, suas metas, e tudo o mais que você teria que manter espalhado em seis apps e um pedaço de papel. Dois minutos, e você pode parar quando quiser.',
	'tour.yoursToChange': 'Seu, para você mudar',
	...
	'ui.edit': 'Editar',
	'ui.hide': 'Ocultar',
	'ui.hoursAbbrev': '{count}h',
	'ui.hoursMinutesAbbrev': '{hours}h {minutes}min',
	'ui.less': 'Menos',
	...
	'welcome.password.password': 'Senha',
	'welcome.password.yourAccountIsReady': 'Sua conta está pronta — é assim que você entra de novo.',
	'welcome.pasteThisToClaude':
		'Cole isto no Claude — ou em qualquer coisa que fale MCP. A chave só aparece agora;\n\t\t\t\t\t\t\t\t\t\trevogue quando quiser em Configurações → Integrações.',
	'welcome.permissions': 'permissões',
	'welcome.progress': 'Progresso',
	'welcome.quickStepsAllOfIt': 'passos rápidos. Tudo pode ser editado depois.',
	'welcome.skipILlSetThis': 'Pular — eu configuro isso depois',
	'welcome.startPlanning': 'Começar a planejar',
	'welcome.stepNumber': '{number}. {title}',
	'welcome.stepOf': 'Passo {step} de {length}',
	'welcome.thisTokenGivesTheAi':
		'Este token dá à IA a maioria das permissões para editar sua conta. Crie um novo\n\t\t\t\t\t\t\t\t\t\ttoken depois para restringir suas',
	'welcome.welcomeToOntoplano': 'Bem-vindo ao ontoplano',
	...
	'written.openThePicture': 'Abrir a imagem',
	'written.showTheRest': 'Mostrar o resto'
};
