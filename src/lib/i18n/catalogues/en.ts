...
export const messages: Catalogue = {
	...
	'settings.account.middotSignedIn': '&middot; signed in',
	...
	'settings.account.offTurnItOnAnd': 'Off. Turn it on and you get one message on a Monday at',
	'settings.account.oneMessageOnAMonday': 'One message on a Monday at',
	...
	'settings.account.withWhatLastWeekWas':
		'with what last week was — planned against done, and what is still loose. Nothing is sent about a week you did not plan, and every message has a link that stops them.',
	'settings.account.withWhatLastWeekWas2':
		'with what last week was — planned against done, and what is still loose.',
