...
```sh
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.1/ontoplano_0.183.1_amd64.deb
sudo apt install ./ontoplano_0.183.1_amd64.deb
```

**Fedora, RHEL and its rebuilds, openSUSE**

```sh
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.1/ontoplano-0.183.1-1.x86_64.rpm
sudo dnf install ./ontoplano-0.183.1-1.x86_64.rpm     # or: sudo zypper install ./ontoplano-0.183.1-1.x86_64.rpm
```
...
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.1/PKGBUILD
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.1/ontoplano.install
makepkg -si
```
...
```sh
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.1/SHA256SUMS
