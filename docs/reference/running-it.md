...
```sh
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.6/ontoplano_0.183.6_amd64.deb
sudo apt install ./ontoplano_0.183.6_amd64.deb
```

**Fedora, RHEL and its rebuilds, openSUSE**

```sh
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.6/ontoplano-0.183.6-1.x86_64.rpm
sudo dnf install ./ontoplano-0.183.6-1.x86_64.rpm     # or: sudo zypper install ./ontoplano-0.183.6-1.x86_64.rpm
```
...
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.6/PKGBUILD
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.6/ontoplano.install
makepkg -si
```
...
```sh
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.183.6/SHA256SUMS
