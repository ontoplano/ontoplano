...
```sh
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.177.7/ontoplano_0.177.7_amd64.deb
sudo apt install ./ontoplano_0.177.7_amd64.deb
```

**Fedora, RHEL and its rebuilds, openSUSE**

```sh
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.177.7/ontoplano-0.177.7-1.x86_64.rpm
sudo dnf install ./ontoplano-0.177.7-1.x86_64.rpm     # or: sudo zypper install ./ontoplano-0.177.7-1.x86_64.rpm
```
...
```sh
curl -LO https://github.com/ontoplano/ontoplano/releases/download/v0.177.7/SHA256SUMS
