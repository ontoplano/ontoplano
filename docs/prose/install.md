...
<!-- blurb: answer three questions and get the steps for your phone, your browser and your instance -->

# Install it on your phone

Ontoplano installs from the browser. There is no store to go through and
nothing to buy: the app on your home screen is this app, and it works the same
whether you use the hosted instance or one you run yourself.
...
## What installing from the browser does _not_ get you

**The home-screen widget.** Android only lets an installed _app_ provide a
widget, and a web app added from the browser is not one, however much it
behaves like it. If you want today's blocks on your home screen without opening
anything, you need the Android package — see [On your phone](on-your-phone.md).

Everything else is identical. The APK is the same app in a wrapper; there is no
feature behind it.
